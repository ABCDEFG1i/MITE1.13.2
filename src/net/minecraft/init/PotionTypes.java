...
public class PotionTypes {
   ...
   private static PotionType getRegisteredPotionType(String p_185217_0_) {
      PotionType potiontype = IRegistry.field_212621_j.func_82594_a(new ResourceLocation(p_185217_0_));
