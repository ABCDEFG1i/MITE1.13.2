...
public class Fluids {
   ...
   private static Fluid getRegisteredFluid(String p_207211_0_) {
      Fluid fluid = IRegistry.field_212619_h.func_82594_a(new ResourceLocation(p_207211_0_));
      if (!CACHE.add(fluid)) {
         throw new IllegalStateException("Invalid Fluid requested: " + p_207211_0_);
      } else {
         return fluid;
      }
   }
