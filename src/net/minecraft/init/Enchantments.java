...
public class Enchantments {
   ...
   @Nullable
   private static Enchantment getRegisteredEnchantment(String p_185295_0_) {
      Enchantment enchantment = IRegistry.field_212628_q.func_212608_b(new ResourceLocation(p_185295_0_));
      if (enchantment == null) {
