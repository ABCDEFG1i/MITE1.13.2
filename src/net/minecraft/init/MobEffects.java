...
public class MobEffects {
   ...
   public static final Potion CONDUIT_POWER;
   public static final Potion DOLPHINS_GRACE;

   @Nullable
   private static Potion getRegisteredMobEffect(String p_188422_0_) {
      Potion potion = IRegistry.field_212631_t.func_212608_b(new ResourceLocation(p_188422_0_));
      if (potion == null) {
   ...
   static {
      if (!Bootstrap.isRegistered()) {
         ...
         SLOW_FALLING = getRegisteredMobEffect("slow_falling");
         CONDUIT_POWER = getRegisteredMobEffect("conduit_power");
         DOLPHINS_GRACE = getRegisteredMobEffect("dolphins_grace");
      }
   }
}
