...
public class BlockSixWay extends Block {
   ...
   public VoxelShape getShape(IBlockState p_196244_1_, IBlockReader p_196244_2_, BlockPos p_196244_3_) {
      return this.shapes[this.getShapeIndex(p_196244_1_)];
   }

   protected int getShapeIndex(IBlockState p_196486_1_) {
      int i = 0;

      for(int j = 0; j < FACING_VALUES.length; ++j) {
         if (p_196486_1_.get(FACING_TO_PROPERTY_MAP.get(FACING_VALUES[j]))) {
            i |= 1 << j;
         }
      }
