...
public class MaterialColor {
   ...
   public static final MaterialColor CLOTH = new MaterialColor(3, 13092807);
   ...
   public static final MaterialColor SILVER = new MaterialColor(22, 10066329);
   ...
   public static final MaterialColor WHITE_STAINED_HARDENED_CLAY = new MaterialColor(36, 13742497);
   public static final MaterialColor ORANGE_STAINED_HARDENED_CLAY = new MaterialColor(37, 10441252);
   public static final MaterialColor MAGENTA_STAINED_HARDENED_CLAY = new MaterialColor(38, 9787244);
   public static final MaterialColor LIGHT_BLUE_STAINED_HARDENED_CLAY = new MaterialColor(39, 7367818);
   public static final MaterialColor YELLOW_STAINED_HARDENED_CLAY = new MaterialColor(40, 12223780);
   public static final MaterialColor LIME_STAINED_HARDENED_CLAY = new MaterialColor(41, 6780213);
   public static final MaterialColor PINK_STAINED_HARDENED_CLAY = new MaterialColor(42, 10505550);
   public static final MaterialColor GRAY_STAINED_HARDENED_CLAY = new MaterialColor(43, 3746083);
   public static final MaterialColor SILVER_STAINED_HARDENED_CLAY = new MaterialColor(44, 8874850);
   public static final MaterialColor CYAN_STAINED_HARDENED_CLAY = new MaterialColor(45, 5725276);
   public static final MaterialColor PURPLE_STAINED_HARDENED_CLAY = new MaterialColor(46, 8014168);
   public static final MaterialColor BLUE_STAINED_HARDENED_CLAY = new MaterialColor(47, 4996700);
   public static final MaterialColor BROWN_STAINED_HARDENED_CLAY = new MaterialColor(48, 4993571);
   public static final MaterialColor GREEN_STAINED_HARDENED_CLAY = new MaterialColor(49, 5001770);
   public static final MaterialColor RED_STAINED_HARDENED_CLAY = new MaterialColor(50, 9321518);
   public static final MaterialColor BLACK_STAINED_HARDENED_CLAY = new MaterialColor(51, 2430480);
   public final int colorValue;
   public final int colorIndex;

   private MaterialColor(int colorIndex, int colorValue) {
      if (colorIndex >= 0 && colorIndex <= 63) {
         this.colorIndex = colorIndex;
         this.colorValue = colorValue;
         COLORS[colorIndex] = this;
      } else {
