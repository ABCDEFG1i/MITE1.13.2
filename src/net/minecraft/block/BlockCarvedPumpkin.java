...
public class BlockCarvedPumpkin extends BlockHorizontal {
   ...
   public void onBlockAdded(IBlockState p_196259_1_, World p_196259_2_, BlockPos p_196259_3_, IBlockState p_196259_4_) {
      if (p_196259_4_.getBlock() != p_196259_1_.getBlock()) {
         this.trySpawnGolem(p_196259_2_, p_196259_3_);
      }
   }
   ...
   private void trySpawnGolem(World p_196358_1_, BlockPos p_196358_2_) {
      ...
      if (blockpattern$patternhelper != null) {
         ...
         for(EntityPlayerMP entityplayermp : p_196358_1_.getEntitiesWithinAABB(EntityPlayerMP.class, entitysnowman.getEntityBoundingBox().grow(5.0D))) {
         ...
         if (blockpattern$patternhelper != null) {
            ...
            for(EntityPlayerMP entityplayermp1 : p_196358_1_.getEntitiesWithinAABB(EntityPlayerMP.class, entityirongolem.getEntityBoundingBox().grow(5.0D))) {
