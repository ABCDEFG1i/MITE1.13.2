...
public class BlockUnderworldPortal extends BlockNetherPortal {
    public BlockUnderworldPortal(Properties p_i48352_1_) {
        super(p_i48352_1_);
    }
    public boolean trySpawnPortal(IWorld p_176548_1_, BlockPos p_176548_2_) {
        BlockUnderworldPortal.Size blockportal$size = this.func_201816_b(p_176548_1_, p_176548_2_);
    ...
    @Nullable
    public BlockUnderworldPortal.Size func_201816_b(IWorld p_201816_1_, BlockPos p_201816_2_) {
        BlockUnderworldPortal.Size blockportal$size = new BlockUnderworldPortal.Size(p_201816_1_, p_201816_2_, EnumFacing.Axis.X);
        if (blockportal$size.isValid() && blockportal$size.portalBlockCount == 0) {
            return blockportal$size;
        } else {
            BlockUnderworldPortal.Size blockportal$size1 = new BlockUnderworldPortal.Size(p_201816_1_, p_201816_2_, EnumFacing.Axis.Z);
    ...
    public IBlockState updatePostPlacement(IBlockState p_196271_1_, EnumFacing p_196271_2_, IBlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
        ...
        return !flag && p_196271_3_.getBlock() != this && !(new BlockUnderworldPortal.Size(p_196271_4_, p_196271_5_, enumfacing$axis1)).func_208508_f() ? Blocks.AIR.getDefaultState() : super.updatePostPlacement(p_196271_1_, p_196271_2_, p_196271_3_, p_196271_4_, p_196271_5_, p_196271_6_);
    }
    public BlockPattern.PatternHelper createPatternHelper(IWorld p_181089_1_, BlockPos p_181089_2_) {
        EnumFacing.Axis enumfacing$axis = EnumFacing.Axis.Z;
        BlockUnderworldPortal.Size blockportal$size = new BlockUnderworldPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(p_181089_1_, true);
        if (!blockportal$size.isValid()) {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new BlockUnderworldPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size extends BlockNetherPortal.Size{
        ...
        protected int calculatePortalHeight() {
            ...
            for(this.height = 0; this.height < 21; ++this.height) {
                for(int i = 0; i < this.width; ++i) {
                    ...
                    if (block == Blocks.UNDERWORLD_PORTAL) {
        ...
        protected boolean func_196900_a(IBlockState p_196900_1_) {
            ...
            return p_196900_1_.isAir() || block == Blocks.FIRE || block == Blocks.UNDERWORLD_PORTAL;
        }
        public void placePortalBlocks() {
            for(int i = 0; i < this.width; ++i) {
                ...
                for(int j = 0; j < this.height; ++j) {
                    this.world.setBlockState(blockpos.up(j), Blocks.UNDERWORLD_PORTAL.getDefaultState().with(BlockUnderworldPortal.AXIS, this.axis), 18);
                }
            }
