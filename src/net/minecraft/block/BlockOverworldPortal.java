...
public class BlockOverworldPortal extends BlockNetherPortal {
    public BlockOverworldPortal(Properties p_i48352_1_) {
        super(p_i48352_1_);
    }
    public boolean trySpawnPortal(IWorld p_176548_1_, BlockPos p_176548_2_) {
        BlockOverworldPortal.Size blockportal$size = this.func_201816_b(p_176548_1_, p_176548_2_);
    ...
    public void onEntityCollision(IBlockState p_196262_1_, World p_196262_2_, BlockPos p_196262_3_, Entity p_196262_4_) {
        if (!p_196262_4_.isRiding() && !p_196262_4_.isBeingRidden() && p_196262_4_.isNonBoss()) {
            if (p_196262_2_.getDimension().getType()== DimensionType.UNDERWORLD){
                p_196262_4_.setPortal(p_196262_3_, DimensionType.OVERWORLD);
            }else{
                p_196262_4_.setPortal(p_196262_3_, DimensionType.UNDERWORLD);
            }
        }

    }
    @Nullable
    public BlockOverworldPortal.Size func_201816_b(IWorld p_201816_1_, BlockPos p_201816_2_) {
        BlockOverworldPortal.Size blockportal$size = new BlockOverworldPortal.Size(p_201816_1_, p_201816_2_, EnumFacing.Axis.X);
        if (blockportal$size.isValid() && blockportal$size.portalBlockCount == 0) {
            return blockportal$size;
        } else {
            BlockOverworldPortal.Size blockportal$size1 = new BlockOverworldPortal.Size(p_201816_1_, p_201816_2_, EnumFacing.Axis.Z);
    ...
    public IBlockState updatePostPlacement(IBlockState p_196271_1_, EnumFacing p_196271_2_, IBlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
        ...
        return !flag && p_196271_3_.getBlock() != this && !(new BlockOverworldPortal.Size(p_196271_4_, p_196271_5_, enumfacing$axis1)).func_208508_f() ? Blocks.AIR.getDefaultState() : super.updatePostPlacement(p_196271_1_, p_196271_2_, p_196271_3_, p_196271_4_, p_196271_5_, p_196271_6_);
    }
    public BlockPattern.PatternHelper createPatternHelper(IWorld p_181089_1_, BlockPos p_181089_2_) {
        EnumFacing.Axis enumfacing$axis = EnumFacing.Axis.Z;
        BlockOverworldPortal.Size blockportal$size = new BlockOverworldPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(p_181089_1_, true);
        if (!blockportal$size.isValid()) {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new BlockOverworldPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size extends BlockNetherPortal.Size{
        Size(IWorld p_i48740_1_, BlockPos p_i48740_2_, EnumFacing.Axis p_i48740_3_) {
        ...
        protected int calculatePortalHeight() {
            ...
            for(this.height = 0; this.height < 21; ++this.height) {
                for(int i = 0; i < this.width; ++i) {
                    ...
                    if (block == Blocks.OVERWORLD_PORTAL) {
        ...
        protected boolean func_196900_a(IBlockState p_196900_1_) {
            ...
            return p_196900_1_.isAir() || block == Blocks.FIRE || block == Blocks.OVERWORLD_PORTAL;
        }
        public void placePortalBlocks() {
            for(int i = 0; i < this.width; ++i) {
                ...
                for(int j = 0; j < this.height; ++j) {
                    this.world.setBlockState(blockpos.up(j), Blocks.OVERWORLD_PORTAL.getDefaultState().with(BlockOverworldPortal.AXIS, this.axis), 18);
                }
            }
