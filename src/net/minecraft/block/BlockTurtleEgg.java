...
public class BlockTurtleEgg extends Block {
   ...
   public void tick(IBlockState p_196267_1_, World p_196267_2_, BlockPos p_196267_3_, Random p_196267_4_) {
      if (this.canGrow(p_196267_2_) && this.hasProperHabitat(p_196267_2_, p_196267_3_)) {
         ...
         if (i < 2) {
            p_196267_2_.playSound((EntityPlayer)null, p_196267_3_, SoundEvents.ENTITY_TURTLE_EGG_CRACK, SoundCategory.BLOCKS, 0.7F, 0.9F + p_196267_4_.nextFloat() * 0.2F);
            p_196267_2_.setBlockState(p_196267_3_, p_196267_1_.with(HATCH, Integer.valueOf(i + 1)), 2);
         } else {
            p_196267_2_.playSound((EntityPlayer)null, p_196267_3_, SoundEvents.ENTITY_TURTLE_EGG_HATCH, SoundCategory.BLOCKS, 0.7F, 0.9F + p_196267_4_.nextFloat() * 0.2F);
   ...
   public boolean isReplaceable(IBlockState p_196253_1_, BlockItemUseContext p_196253_2_) {
      return p_196253_2_.getItem().getItem() == this.asItem() && p_196253_1_.get(EGGS) < 4 ? true : super.isReplaceable(p_196253_1_, p_196253_2_);
   }
