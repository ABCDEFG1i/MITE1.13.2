...
public class Block implements IItemProvider {
    ...
    private static final ThreadLocal<Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey>> SHOULD_SIDE_RENDER_CACHE =
            ThreadLocal.withInitial(() -> {
                Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey> object2bytelinkedopenhashmap =
                        new Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey>(200) {
    ...
    private static final EnumFacing[] field_212556_a =
            new EnumFacing[]{EnumFacing.WEST, EnumFacing.EAST, EnumFacing.NORTH, EnumFacing.SOUTH, EnumFacing.DOWN,
                    EnumFacing.UP};
    ...
    public static void registerBlocks() {
        ...
        register("gold_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK).setHardnessAndResistance(3.0F, 3.0F),2));
        register("iron_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK).setHardnessAndResistance(3.0F, 3.0F),2));
        register("coal_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK).setHardnessAndResistance(3.0F, 3.0F),2));
        ...
        register("lapis_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK).setHardnessAndResistance(3.0F, 3.0F),2));
        register("lapis_block", new BlockMaterial(Block.Properties.createBlockProperties(Material.IRON, MaterialColor.LAPIS).setHardnessAndResistance(3.0F, 3.0F),2));
        ...
        register("gold_block", new BlockMaterial(Block.Properties.createBlockProperties(Material.IRON, MaterialColor.GOLD).setHardnessAndResistance(3.0F, 6.0F).setSoundType(SoundType.METAL),3));
        register("iron_block", new BlockMaterial(Block.Properties.createBlockProperties(Material.IRON, MaterialColor.IRON).setHardnessAndResistance(5.0F, 6.0F).setSoundType(SoundType.METAL),4));
        ...
        register("obsidian", new BlockMaterial(Block.Properties.createBlockProperties(Material.ROCK, MaterialColor.BLACK).setHardnessAndResistance(50.0F, 1200.0F),3));
        ...
        register("diamond_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK).setHardnessAndResistance(3.0F, 3.0F),4));
        register("diamond_block", new BlockMaterial(Block.Properties.createBlockProperties(Material.IRON, MaterialColor.DIAMOND).setHardnessAndResistance(5.0F, 6.0F).setSoundType(SoundType.METAL),5));
        ...
        register("emerald_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK).setHardnessAndResistance(3.0F, 3.0F),3));
        ...
        register("emerald_block", new BlockMaterial(Block.Properties.createBlockProperties(Material.IRON, MaterialColor.EMERALD).setHardnessAndResistance(5.0F, 6.0F).setSoundType(SoundType.METAL),4));
        ...
        register("nether_quartz_ore", new BlockOre(Block.Properties.createBlockProperties(Material.ROCK, MaterialColor.NETHERRACK).setHardnessAndResistance(3.0F, 3.0F),2));
    ...
    public static void spawnAsEntity(World p_180635_0_, BlockPos p_180635_1_, ItemStack p_180635_2_) {
        if (!p_180635_0_.isRemote && !p_180635_2_.isEmpty() && p_180635_0_.getGameRules().getBoolean("doTileDrops")) {
            ...
            EntityItem entityitem = new EntityItem(p_180635_0_, (double) p_180635_1_.getX() + d0,
                                                   (double) p_180635_1_.getY() + d1, (double) p_180635_1_.getZ() + d2,
                                                   p_180635_2_);
        ...
        if (!p_180637_1_.isRemote && p_180637_1_.getGameRules().getBoolean("doTileDrops")) {
            while(p_180637_3_ > 0) {
                ...
                p_180637_1_.spawnEntity(new EntityXPOrb(p_180637_1_, (double) p_180637_2_.getX() + 0.5D,
                                                        (double) p_180637_2_.getY() + 0.5D,
                                                        (double) p_180637_2_.getZ() + 0.5D, i));
            }
        }
        ...
        if (block$enumoffsettype == Block.EnumOffsetType.NONE) {
            ...
            return new Vec3d(((double) ((float) (i & 15L) / 15.0F) - 0.5D) * 0.5D,
                             block$enumoffsettype == Block.EnumOffsetType.XYZ ?
                                     ((double) ((float) (i >> 4 & 15L) / 15.0F) - 1.0D) * 0.2D : 0.0D,
    ...
    public final boolean isOpaqueCube(IBlockState p_200012_1_, IBlockReader p_200012_2_, BlockPos p_200012_3_) {
        ...
        VoxelShape voxelshape = flag ? p_200012_1_.getRenderShape(p_200012_2_, p_200012_3_) : VoxelShapes
                .func_197880_a();
        return isOpaque(voxelshape);
    }
        ...
        try (BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos = BlockPos.PooledMutableBlockPos.retain()) {
            for(EnumFacing enumfacing : field_212556_a) {
                ...
                IBlockState iblockstate1 = iblockstate.updatePostPlacement(enumfacing.getOpposite(), p_196242_1_,
                                                                           p_196242_2_, blockpos$pooledmutableblockpos,
                                                                           p_196242_3_);
    ...
    public static final class RenderSideCacheKey {
        ...
        public boolean equals(Object p_equals_1_) {
            if (this == p_equals_1_) {
                ...
                return this.state == block$rendersidecachekey.state &&
                       this.adjacentState == block$rendersidecachekey.adjacentState &&
                       this.side == block$rendersidecachekey.side;
            }
        }
    }
}
