...
public class SPacketCommandList implements Packet<INetHandlerPlayClient> {
   ...
   public void readPacketData(PacketBuffer p_148837_1_) throws IOException {
      SPacketCommandList.Entry[] aspacketcommandlist$entry = new SPacketCommandList.Entry[p_148837_1_.readVarInt()];
      ...
      for(int i = 0; i < aspacketcommandlist$entry.length; ++i) {
         aspacketcommandlist$entry[i] = this.func_197692_c(p_148837_1_);
      ...
      this.root = (RootCommandNode)aspacketcommandlist$entry[p_148837_1_.readVarInt()].field_197730_e;
   }
   ...
   public void writePacketData(PacketBuffer p_148840_1_) throws IOException {
      ...
      for(CommandNode<ISuggestionProvider> commandnode1 : commandnode2) {
         this.func_197696_a(p_148840_1_, commandnode1, map);
      }
