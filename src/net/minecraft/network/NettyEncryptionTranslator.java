...
public class NettyEncryptionTranslator {
   ...
   private byte[] bufToBytes(ByteBuf p_150502_1_) {
      ...
      p_150502_1_.readBytes(this.inputBuffer, 0, i);
   ...
   protected ByteBuf decipher(ChannelHandlerContext p_150503_1_, ByteBuf p_150503_2_) throws ShortBufferException {
      ...
      byte[] abyte = this.bufToBytes(p_150503_2_);
   ...
   protected void cipher(ByteBuf p_150504_1_, ByteBuf p_150504_2_) throws ShortBufferException {
      ...
      byte[] abyte = this.bufToBytes(p_150504_1_);
      int j = this.cipher.getOutputSize(i);
      if (this.outputBuffer.length < j) {
         this.outputBuffer = new byte[j];
      }

      p_150504_2_.writeBytes(this.outputBuffer, 0, this.cipher.update(abyte, 0, i, this.outputBuffer));
   }
}
