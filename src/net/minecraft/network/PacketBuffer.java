...
public class PacketBuffer extends ByteBuf {
   ...
   public PacketBuffer writeTextComponent(ITextComponent p_179256_1_) {
      return this.func_211400_a(ITextComponent.Serializer.toJson(p_179256_1_), 262144);
   }
   ...
   public PacketBuffer writeCompoundTag(@Nullable NBTTagCompound p_150786_1_) {
      if (p_150786_1_ == null) {
         this.writeByte(0);
      } else {
         try {
   ...
   public PacketBuffer writeItemStack(ItemStack p_150788_1_) {
      if (p_150788_1_.isEmpty()) {
         ...
         if (item.isDamageable() || item.getShareTag()) {
            nbttagcompound = p_150788_1_.getTag();
         }
   ...
   public PacketBuffer writeString(String p_180714_1_) {
      return this.func_211400_a(p_180714_1_, 32767);
   }
