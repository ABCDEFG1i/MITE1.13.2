...
public enum EnumConnectionState {
   ...
   protected EnumConnectionState registerPacket(EnumPacketDirection p_179245_1_, Class<? extends Packet<?>> p_179245_2_) {
      BiMap<Integer, Class<? extends Packet<?>>> bimap = this.directionMaps.get(p_179245_1_);
      if (bimap == null) {
         bimap = HashBiMap.create();
         this.directionMaps.put(p_179245_1_, bimap);
      }
      ...
      if (bimap.containsValue(p_179245_2_)) {
         ...
         bimap.put(bimap.size(), p_179245_2_);
         return this;
      }
   }

   public Integer getPacketId(EnumPacketDirection p_179246_1_, Packet<?> p_179246_2_) throws Exception {
      return this.directionMaps.get(p_179246_1_).inverse().get(p_179246_2_.getClass());
   }

   @Nullable
   public Packet<?> getPacket(EnumPacketDirection p_179244_1_, int p_179244_2_) throws IllegalAccessException, InstantiationException {
      Class<? extends Packet<?>> oclass = this.directionMaps.get(p_179244_1_).get(Integer.valueOf(p_179244_2_));
   ...
   public static EnumConnectionState getById(int p_150760_0_) {
      return p_150760_0_ >= -1 && p_150760_0_ <= 2 ? STATES_BY_ID[p_150760_0_ - -1] : null;
   }

   public static EnumConnectionState getFromPacket(Packet<?> p_150752_0_) {
      return STATES_BY_CLASS.get(p_150752_0_.getClass());
   }
