...
public class CompressedStreamTools {
   ...
   public static NBTTagCompound read(DataInput p_152456_0_, NBTSizeTracker p_152456_1_) throws IOException {
      INBTBase inbtbase = read(p_152456_0_, 0, p_152456_1_);
   ...
   private static void writeTag(INBTBase p_150663_0_, DataOutput p_150663_1_) throws IOException {
   ...
   private static INBTBase read(DataInput p_152455_0_, int p_152455_1_, NBTSizeTracker p_152455_2_) throws IOException {
      ...
      if (b0 == 0) {
         ...
         try {
            inbtbase.read(p_152455_0_, p_152455_1_, p_152455_2_);
            return inbtbase;
