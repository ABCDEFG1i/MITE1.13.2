...
public class VillageDoorInfo {
   ...
   private static EnumFacing getFaceDirection(int p_179854_0_, int p_179854_1_) {
      if (p_179854_0_ < 0) {
   ...
   public VillageDoorInfo(BlockPos p_i45872_1_, EnumFacing p_i45872_2_, int p_i45872_3_) {
      this.doorBlockPos = p_i45872_1_.toImmutable();
   ...
   public boolean isInsideSide(BlockPos p_179850_1_) {
   ...
   public void setLastActivityTimestamp(int p_179849_1_) {
