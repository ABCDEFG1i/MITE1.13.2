...
public class BlockTagsProvider extends TagsProvider<Block> {
   public BlockTagsProvider(DataGenerator p_i48256_1_) {
      super(p_i48256_1_, IRegistry.field_212618_g);
   }
   ...
   protected void registerTags() {
      ...
      this.getBuilder(BlockTags.ANVIL).add(
              Blocks.COPPER_ANVIL,Blocks.CHIPPED_COPPER_ANVIL, Blocks.DAMAGED_COPPER_ANVIL,
              Blocks.SILVER_ANVIL, Blocks.CHIPPED_SILVER_ANVIL, Blocks.DAMAGED_SILVER_ANVIL,
              Blocks.GOLD_ANVIL, Blocks.CHIPPED_GOLD_ANVIL,Blocks.DAMAGED_GOLD_ANVIL,
              Blocks.IRON_ANVIL, Blocks.CHIPPED_IRON_ANVIL, Blocks.DAMAGED_IRON_ANVIL,
              Blocks.ANCIENT_METAL_ANVIL,Blocks.CHIPPED_ANCIENT_METAL_ANVIL, Blocks.DAMAGED_ANCIENT_METAL_ANVIL,
              Blocks.MITHRIL_ANVIL,Blocks.CHIPPED_MITHRIL_ANVIL,Blocks.DAMAGED_MITHRIL_ANVIL,
              Blocks.TUNGSTEN_ANVIL,Blocks.CHIPPED_TUNGSTEN_ANVIL,Blocks.DAMAGED_TUNGSTEN_ANVIL,
              Blocks.ADAMANTIUM_ANVIL, Blocks.CHIPPED_ADAMANTIUM_ANVIL,Blocks.DAMAGED_ADAMANTIUM_ANVIL
      );
      this.getBuilder(BlockTags.CRAFTING_TABLE).add(
              Blocks.FLINT_CRAFTING_TABLE,Blocks.COPPER_CRAFTING_TABLE,Blocks.SILVER_CRAFTING_TABLE,Blocks.IRON_CRAFTING_TABLE,Blocks.GOLD_CRAFTING_TABLE,Blocks.ANCIENT_METAL_CRAFTING_TABLE,Blocks.MITHRIL_CRAFTING_TABLE,Blocks.TUNGSTEN_CRAFTING_TABLE,Blocks.ADAMANTIUM_CRAFTING_TABLE,Blocks.OBSIDIAN_CRAFTING_TABLE
      );
      this.getBuilder(BlockTags.FURNACE).add(
              Blocks.CLAY_FURNACE, Blocks.HARDENED_CLAY_FURNACE,Blocks.COBBLESTONE_FURNACE, Blocks.NETHERRACK_FURNACE,Blocks.OBSIDIAN_FURNACE,
              Blocks.SANDSTONE_FURNACE
      );
      this.getBuilder(BlockTags.PORTALS).add(
              Blocks.NETHER_PORTAL,Blocks.OVERWORLD_PORTAL, Blocks.UNDERWORLD_PORTAL,Blocks.WORLDSPAWN_PORTAL
      );
      this.getBuilder(BlockTags.UNDERGROUND_FILL).add(Blocks.STONE,Blocks.GRANITE,Blocks.ANDESITE,Blocks.DIORITE,Blocks.DIRT,Blocks.GRAVEL,Blocks.WATER,Blocks.LAVA);
