...
public class EndAdvancements implements Consumer<Consumer<Advancement>> {
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement advancement1 = Advancement.Builder.builder().withParent(advancement).withDisplay(Blocks.DRAGON_HEAD, new TextComponentTranslation("advancements.end.kill_dragon.title"), new TextComponentTranslation("advancements.end.kill_dragon.description"),
              null, FrameType.TASK, true, true, false).withCriterion("killed_dragon", KilledTrigger.Instance.func_203928_a(EntityPredicate.Builder.func_203996_a().func_203998_a(EntityType.ENDER_DRAGON))).register(p_accept_1_, "end/kill_dragon");
      Advancement advancement2 = Advancement.Builder.builder().withParent(advancement1).withDisplay(Items.ENDER_PEARL, new TextComponentTranslation("advancements.end.enter_end_gateway.title"), new TextComponentTranslation("advancements.end.enter_end_gateway.description"),
              null, FrameType.TASK, true, true, false).withCriterion("entered_end_gateway", EnterBlockTrigger.Instance.func_203920_a(Blocks.END_GATEWAY)).register(p_accept_1_, "end/enter_end_gateway");
      Advancement advancement3 = Advancement.Builder.builder().withParent(advancement1).withDisplay(Items.END_CRYSTAL, new TextComponentTranslation("advancements.end.respawn_dragon.title"), new TextComponentTranslation("advancements.end.respawn_dragon.description"),
              null, FrameType.GOAL, true, true, false).withCriterion("summoned_dragon", SummonedEntityTrigger.Instance.func_203937_a(EntityPredicate.Builder.func_203996_a().func_203998_a(EntityType.ENDER_DRAGON))).register(p_accept_1_, "end/respawn_dragon");
