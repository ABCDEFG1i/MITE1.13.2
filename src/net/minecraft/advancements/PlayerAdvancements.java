...
public class PlayerAdvancements {
   ...
   public void setPlayer(EntityPlayerMP p_192739_1_) {
   ...
   private void load() {
      if (this.progressFile.isFile()) {
         try (JsonReader jsonreader = new JsonReader(new StringReader(Files.toString(this.progressFile, StandardCharsets.UTF_8)))) {
            ...
            dynamic = this.server.getDataFixer().update(DataFixTypes.ADVANCEMENTS, dynamic, dynamic.getInt("DataVersion"), 1631);
   ...
   public AdvancementProgress getProgress(Advancement p_192747_1_) {
      AdvancementProgress advancementprogress = this.progress.get(p_192747_1_);
