...
public class FunctionManager implements ITickable, IResourceManagerReloadListener {
   ...
   @Nullable
   public FunctionObject getFunction(ResourceLocation p_193058_1_) {
   ...
   public void onResourceManagerReload(IResourceManager p_195410_1_) {
      ...
      Collection<ResourceLocation> collection = p_195410_1_.getAllResourceLocations("functions", (p_195453_0_) -> {
      ...
      for(ResourceLocation resourcelocation : collection) {
         ...
         list.add(CompletableFuture.supplyAsync(() -> {
            return readLines(p_195410_1_, resourcelocation);
