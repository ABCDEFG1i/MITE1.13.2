...
public class FilledBucketTrigger implements ICriterionTrigger<FilledBucketTrigger.Instance> {
   ...
   public void addListener(PlayerAdvancements p_192165_1_, ICriterionTrigger.Listener<FilledBucketTrigger.Instance> p_192165_2_) {
      FilledBucketTrigger.Listeners filledbuckettrigger$listeners = this.field_204819_b.get(p_192165_1_);
      if (filledbuckettrigger$listeners == null) {
         filledbuckettrigger$listeners = new FilledBucketTrigger.Listeners(p_192165_1_);
         this.field_204819_b.put(p_192165_1_, filledbuckettrigger$listeners);
      }

      filledbuckettrigger$listeners.func_204852_a(p_192165_2_);
   }

   public void removeListener(PlayerAdvancements p_192164_1_, ICriterionTrigger.Listener<FilledBucketTrigger.Instance> p_192164_2_) {
      FilledBucketTrigger.Listeners filledbuckettrigger$listeners = this.field_204819_b.get(p_192164_1_);
      if (filledbuckettrigger$listeners != null) {
         filledbuckettrigger$listeners.func_204855_b(p_192164_2_);
         if (filledbuckettrigger$listeners.func_204853_a()) {
            this.field_204819_b.remove(p_192164_1_);
         }
      }
   ...
   public void removeAllListeners(PlayerAdvancements p_192167_1_) {
      this.field_204819_b.remove(p_192167_1_);
   }
