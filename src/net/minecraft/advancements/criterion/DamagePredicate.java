...
public class DamagePredicate {
   ...
   public boolean test(EntityPlayerMP p_192365_1_, DamageSource p_192365_2_, float p_192365_3_, float p_192365_4_, boolean p_192365_5_) {
      if (this == ANY) {
         return true;
   ...
   public static class Builder {
      ...
      public DamagePredicate.Builder type(DamageSourcePredicate.Builder p_203969_1_) {
         this.type = p_203969_1_.func_203979_b();
         return this;
      }
