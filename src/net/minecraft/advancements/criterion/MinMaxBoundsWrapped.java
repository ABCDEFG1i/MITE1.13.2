...
public class MinMaxBoundsWrapped {
   ...
   public static MinMaxBoundsWrapped func_207921_a(StringReader p_207921_0_, boolean p_207921_1_, Function<Float, Float> p_207921_2_) throws CommandSyntaxException {
      if (!p_207921_0_.canRead()) {
         throw MinMaxBounds.field_196978_b.createWithContext(p_207921_0_);
      } else {
         int i = p_207921_0_.getCursor();
         Float f = func_207922_a(func_207924_b(p_207921_0_, p_207921_1_), p_207921_2_);
         Float f1;
         if (p_207921_0_.canRead(2) && p_207921_0_.peek() == '.' && p_207921_0_.peek(1) == '.') {
            p_207921_0_.skip();
            p_207921_0_.skip();
            f1 = func_207922_a(func_207924_b(p_207921_0_, p_207921_1_), p_207921_2_);
            if (f == null && f1 == null) {
            ...
            if (!p_207921_1_ && p_207921_0_.canRead() && p_207921_0_.peek() == '.') {
               p_207921_0_.setCursor(i);
               throw field_211362_b.createWithContext(p_207921_0_);
            }
   ...
   @Nullable
   private static Float func_207922_a(@Nullable Float p_207922_0_, Function<Float, Float> p_207922_1_) {
