...
public class DataFixesManager {
   ...
   private static void addFixers(DataFixerBuilder p_210891_0_) {
      ...
      Schema schema2 = p_210891_0_.addSchema(101, SCHEMA_FACTORY);
      ...
      Schema schema4 = p_210891_0_.addSchema(105, SCHEMA_FACTORY);
      ...
      Schema schema7 = p_210891_0_.addSchema(108, SCHEMA_FACTORY);
      p_210891_0_.addFixer(new StringToUUID(schema7, true));
      Schema schema8 = p_210891_0_.addSchema(109, SCHEMA_FACTORY);
      p_210891_0_.addFixer(new EntityHealth(schema8, true));
      Schema schema9 = p_210891_0_.addSchema(110, SCHEMA_FACTORY);
      p_210891_0_.addFixer(new HorseSaddle(schema9, true));
      Schema schema10 = p_210891_0_.addSchema(111, SCHEMA_FACTORY);
      p_210891_0_.addFixer(new PaintingDirection(schema10, true));
      Schema schema11 = p_210891_0_.addSchema(113, SCHEMA_FACTORY);
      ...
      Schema schema14 = p_210891_0_.addSchema(147, SCHEMA_FACTORY);
      p_210891_0_.addFixer(new ArmorStandSilent(schema14, true));
      Schema schema15 = p_210891_0_.addSchema(165, SCHEMA_FACTORY);
      ...
      Schema schema17 = p_210891_0_.addSchema(502, SCHEMA_FACTORY);
      ...
      Schema schema18 = p_210891_0_.addSchema(505, SCHEMA_FACTORY);
      ...
      Schema schema25 = p_210891_0_.addSchema(804, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new BannerItemColor(schema25, true));
      Schema schema26 = p_210891_0_.addSchema(806, NAMESPACED_SCHEMA_FACTORY);
      ...
      Schema schema28 = p_210891_0_.addSchema(808, 1, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new ShulkerBoxEntityColor(schema28, false));
      Schema schema29 = p_210891_0_.addSchema(813, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new ShulkerBoxItemColor(schema29, false));
      p_210891_0_.addFixer(new ShulkerBoxTileColor(schema29, false));
      Schema schema30 = p_210891_0_.addSchema(816, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new OptionsLowerCaseLanguage(schema30, false));
      Schema schema31 = p_210891_0_.addSchema(820, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(ItemRename.create(schema31, "totem item renamer", (p_207107_0_) -> {
      ...
      Schema schema34 = p_210891_0_.addSchema(1344, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new LWJGL3KeyOptions(schema34, false));
      Schema schema35 = p_210891_0_.addSchema(1446, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new KeyOptionsTranslation(schema35, false));
      Schema schema36 = p_210891_0_.addSchema(1450, NAMESPACED_SCHEMA_FACTORY);
      ...
      Schema schema45 = p_210891_0_.addSchema(1451, 7, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new VillagerTrades(schema45, false));
      Schema schema46 = p_210891_0_.addSchema(1456, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new EntityItemFrameFacing(schema46, false));
      Schema schema47 = p_210891_0_.addSchema(1458, NAMESPACED_SCHEMA_FACTORY);
      ...
      Schema schema51 = p_210891_0_.addSchema(1474, NAMESPACED_SCHEMA_FACTORY);
      ...
      Schema schema52 = p_210891_0_.addSchema(1475, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(BlockRename.create(schema52, "Flowing fixer", (p_207100_0_) -> {
      ...
      Schema schema53 = p_210891_0_.addSchema(1480, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(BlockRename.create(schema53, "Rename coral blocks", (p_207104_0_) -> {
         return RenamedCoral.field_204918_a.getOrDefault(p_207104_0_, p_207104_0_);
      }));
      p_210891_0_.addFixer(ItemRename.create(schema53, "Rename coral items", (p_207103_0_) -> {
      ...
      p_210891_0_.addFixer(ItemRename.create(schema55, "Rename pufferfish egg item", (p_207552_0_) -> {
         return PufferfishRename.field_207461_a.getOrDefault(p_207552_0_, p_207552_0_);
      }));
      Schema schema56 = p_210891_0_.addSchema(1484, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(ItemRename.create(schema56, "Rename seagrass items", (p_209172_0_) -> {
      ...
      p_210891_0_.addFixer(BlockRename.create(schema56, "Rename seagrass blocks", (p_209168_0_) -> {
      ...
      p_210891_0_.addFixer(ItemRename.create(schema57, "Rename cod/salmon egg items", (p_207551_0_) -> {
         return EntityCodSalmonFix.field_209759_b.getOrDefault(p_207551_0_, p_207551_0_);
      }));
      Schema schema58 = p_210891_0_.addSchema(1487, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(ItemRename.create(schema58, "Rename prismarine_brick(s)_* blocks", (p_207547_0_) -> {
      ...
      p_210891_0_.addFixer(BlockRename.create(schema58, "Rename prismarine_brick(s)_* items", (p_207546_0_) -> {
      ...
      Schema schema59 = p_210891_0_.addSchema(1488, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(BlockRename.create(schema59, "Rename kelp/kelptop", (p_207549_0_) -> {
      ...
      p_210891_0_.addFixer(ItemRename.create(schema59, "Rename kelptop", (p_207548_0_) -> {
      ...
      Schema schema60 = p_210891_0_.addSchema(1490, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(BlockRename.create(schema60, "Rename melon_block", (p_207808_0_) -> {
         return Objects.equals(p_207808_0_, "minecraft:melon_block") ? "minecraft:melon" : p_207808_0_;
      }));
      p_210891_0_.addFixer(ItemRename.create(schema60, "Rename melon_block/melon/speckled_melon", (p_207807_0_) -> {
      ...
      Schema schema61 = p_210891_0_.addSchema(1492, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new ChunkStructuresTemplateRenameFix(schema61, false));
      Schema schema62 = p_210891_0_.addSchema(1494, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new ItemStackEnchantmentFix(schema62, false));
      Schema schema63 = p_210891_0_.addSchema(1496, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new LeavesFix(schema63, false));
      Schema schema64 = p_210891_0_.addSchema(1500, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new BlockEntityKeepPacked(schema64, false));
      Schema schema65 = p_210891_0_.addSchema(1501, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new AdvancementsFix(schema65, false));
      Schema schema66 = p_210891_0_.addSchema(1502, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new RenamedRecipes(schema66, false));
      Schema schema67 = p_210891_0_.addSchema(1506, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new LevelDataGeneratorOptionsFix(schema67, false));
      Schema schema68 = p_210891_0_.addSchema(1508, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new BiomeRenames(schema68, false));
      Schema schema69 = p_210891_0_.addSchema(1510, V1510::new);
      p_210891_0_.addFixer(BlockRename.create(schema69, "Block renamening fix", (p_209169_0_) -> {
         return EntityRenameing1510.field_210596_b.getOrDefault(p_209169_0_, p_209169_0_);
      }));
      p_210891_0_.addFixer(ItemRename.create(schema69, "Item renamening fix", (p_210900_0_) -> {
         return EntityRenameing1510.field_210597_c.getOrDefault(p_210900_0_, p_210900_0_);
      }));
      p_210891_0_.addFixer(new RecipesRenaming(schema69, false));
      p_210891_0_.addFixer(new EntityRenameing1510(schema69, true));
      p_210891_0_.addFixer(new SwimStatsRename(schema69, false));
      Schema schema70 = p_210891_0_.addSchema(1514, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new ObjectiveDisplayName(schema70, false));
      p_210891_0_.addFixer(new TeamDisplayName(schema70, false));
      p_210891_0_.addFixer(new ObjectiveRenderType(schema70, false));
      Schema schema71 = p_210891_0_.addSchema(1515, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(BlockRename.create(schema71, "Rename coral fan blocks", (p_211924_0_) -> {
         return CoralFansRenameList.field_211870_a.getOrDefault(p_211924_0_, p_211924_0_);
      }));
      Schema schema72 = p_210891_0_.addSchema(1624, NAMESPACED_SCHEMA_FACTORY);
      p_210891_0_.addFixer(new TrappedChestTileEntitySplit(schema72, false));
   }
}
