...
public class EntityHealth extends DataFix {
   ...
   public Dynamic<?> func_209743_a(Dynamic<?> p_209743_1_) {
      Optional<Number> optional = p_209743_1_.get("HealF").flatMap(Dynamic::getNumberValue);
      Optional<Number> optional1 = p_209743_1_.get("Health").flatMap(Dynamic::getNumberValue);
      float f;
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityHealthFix", this.getInputSchema().getType(TypeReferences.ENTITY), (p_207449_1_) -> {
         return p_207449_1_.update(DSL.remainderFinder(), this::func_209743_a);
      });
   }
}
