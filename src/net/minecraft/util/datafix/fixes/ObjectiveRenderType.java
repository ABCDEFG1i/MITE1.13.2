...
public class ObjectiveRenderType extends DataFix {
   ...
   private static ScoreCriteria.RenderType func_211858_a(String p_211858_0_) {
            ...
            return (p_211860_0_) -> {
               return p_211860_0_.mapSecond((p_211857_0_) -> {
                  ...
                  if (!optional.isPresent()) {
                     ...
                     ScoreCriteria.RenderType scorecriteria$rendertype = func_211858_a(s);
                     return p_211857_0_.set("RenderType", p_211857_0_.createString(scorecriteria$rendertype.func_211838_a()));
                  } else {
                     return p_211857_0_;
                  }
               });
