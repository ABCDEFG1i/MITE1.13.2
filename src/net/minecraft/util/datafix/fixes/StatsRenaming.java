...
public class StatsRenaming extends DataFix {
         ...
         if (optional.isPresent()) {
            ...
            while(true) {
               ...
               while(true) {
                  ...
                  if (entry.getValue().getNumberValue().isPresent()) {
                     String s = entry.getKey().getStringValue().orElse("");
                     if (!field_209682_a.contains(s)) {
                        ...
                        if (i >= 0) {
                           ...
                           if ("stat.mineBlock".equals(s3)) {
                              s1 = "minecraft:mined";
                              s2 = this.func_206287_a(s.substring(i + 1).replace('.', ':'));
                              break;
                           }
                           ...
                           if (field_199189_b.containsKey(s3)) {
                              ...
                              String s5 = this.func_209681_a(s6);
                              s2 = s5 == null ? s6 : s5;
                              break;
                           }
   ...
   @Nullable
   protected String func_209681_a(String p_209681_1_) {
      return ItemStackDataFlattening.func_199175_a(p_209681_1_, 0);
   }

   protected String func_206287_a(String p_206287_1_) {
