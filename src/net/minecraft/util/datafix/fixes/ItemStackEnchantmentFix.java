   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemStackEnchantmentFix", type, (p_208045_2_) -> {
         return p_208045_2_.updateTyped(opticfinder, (p_208046_1_) -> {
            return p_208046_1_.update(DSL.remainderFinder(), this::func_209627_a);
         });
      });
   }
   ...
   private Dynamic<?> func_209627_a(Dynamic<?> p_209627_1_) {
      Optional<Dynamic<?>> optional = p_209627_1_.get("ench").flatMap(Dynamic::getStream).map((p_209626_0_) -> {
         return p_209626_0_.map((p_209628_0_) -> {
            return p_209628_0_.set("id", p_209628_0_.createString(field_208047_a.getOrDefault(p_209628_0_.getInt("id"), "null")));
         });
      ...
      return p_209627_1_.update("StoredEnchantments", (p_209625_0_) -> {
         return DataFixUtils.orElse(p_209625_0_.getStream().map((p_209623_0_) -> {
            return p_209623_0_.map((p_209624_0_) -> {
               return p_209624_0_.set("id", p_209624_0_.createString(field_208047_a.getOrDefault(p_209624_0_.getInt("id"), "null")));
            });
