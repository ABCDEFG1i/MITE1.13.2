...
public class RidingToPassengers extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.func_206340_a(schema, schema1, type, type1, type2);
   }

   private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule func_206340_a(Schema p_206340_1_, Schema p_206340_2_, Type<OldEntityTree> p_206340_3_, Type<NewEntityTree> p_206340_4_, Type<Entity> p_206340_5_) {
