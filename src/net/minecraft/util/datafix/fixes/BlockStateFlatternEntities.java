...
public class BlockStateFlatternEntities extends DataFix {
   private static final Map<String, Integer> field_199172_a = DataFixUtils.make(Maps.newHashMap(), (p_209311_0_) -> {
   ...
   public static int func_199171_a(String p_199171_0_) {
      Integer integer = field_199172_a.get(p_199171_0_);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function<Typed<?>, Typed<?>> function = (p_211443_1_) -> {
         return this.func_211434_a(p_211443_1_, "DisplayTile", "DisplayData", "DisplayState");
      };
      Function<Typed<?>, Typed<?>> function1 = (p_211429_1_) -> {
         return this.func_211434_a(p_211429_1_, "inTile", "inData", "inBlockState");
      };
      ...
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", schema.getType(TypeReferences.ENTITY), schema1.getType(TypeReferences.ENTITY), (p_211438_4_) -> {
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:falling_block", this::func_211442_a);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:enderman", (p_211433_1_) -> {
            return this.func_211434_a(p_211433_1_, "carried", "carriedData", "carriedBlockState");
         });
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:arrow", function1);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:spectral_arrow", function1);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:egg", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:ender_pearl", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:fireball", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:potion", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:small_fireball", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:snowball", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:wither_skull", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:xp_bottle", function2);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:commandblock_minecart", function);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:minecart", function);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:chest_minecart", function);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:furnace_minecart", function);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:tnt_minecart", function);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:hopper_minecart", function);
         p_211438_4_ = this.func_211431_a(p_211438_4_, "minecraft:spawner_minecart", function);
         return p_211438_4_;
      });
   }

   private Typed<?> func_211442_a(Typed<?> p_211442_1_) {
   ...
   private Typed<?> func_211434_a(Typed<?> p_211434_1_, String p_211434_2_, String p_211434_3_, String p_211434_4_) {
   ...
   private Typed<?> func_211431_a(Typed<?> p_211431_1_, String p_211431_2_, Function<Typed<?>, Typed<?>> p_211431_3_) {
