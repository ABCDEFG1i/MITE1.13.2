...
public class SignStrictJSON extends NamedEntityFix {
   ...
   private Dynamic<?> func_209647_a(Dynamic<?> p_209647_1_, String p_209647_2_) {
   ...
   protected Typed<?> fix(Typed<?> p_207419_1_) {
      return p_207419_1_.update(DSL.remainderFinder(), (p_206380_1_) -> {
         p_206380_1_ = this.func_209647_a(p_206380_1_, "Text1");
         p_206380_1_ = this.func_209647_a(p_206380_1_, "Text2");
         p_206380_1_ = this.func_209647_a(p_206380_1_, "Text3");
         p_206380_1_ = this.func_209647_a(p_206380_1_, "Text4");
         return p_206380_1_;
      });
   }
}
