...
public class BlockStateFlattenGenOptions extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("LevelFlatGeneratorInfoFix", this.getInputSchema().getType(TypeReferences.LEVEL), (p_207414_1_) -> {
         return p_207414_1_.update(DSL.remainderFinder(), this::func_209636_a);
      });
   }
   ...
   private Dynamic<?> func_209636_a(Dynamic<?> p_209636_1_) {
      return p_209636_1_.getString("generatorName").equalsIgnoreCase("flat") ? p_209636_1_.update("generatorOptions", (p_209634_1_) -> {
         return DataFixUtils.orElse(p_209634_1_.getStringValue().map(this::func_199180_a).map(p_209634_1_::createString), p_209634_1_);
      }) : p_209636_1_;
   }

   @VisibleForTesting
   String func_199180_a(String p_199180_1_) {
      if (p_199180_1_.isEmpty()) {
         ...
         if (i >= 0 && i <= 3) {
            ...
            stringbuilder.append(StreamSupport.stream(field_199182_b.split(s1).spliterator(), false).map((p_206368_2_) -> {
               ...
               int l = i == 3 ? BlockStateFlatternEntities.func_199171_a("minecraft:" + s3) : NumberUtils.toInt(s3, 0);
               int i1 = k + 1;
               int j1 = list1.size() > i1 ? NumberUtils.toInt(list1.get(i1), 0) : 0;
               return (j == 1 ? "" : j + "*") + BlockStateFlatteningMap.getFixedNBTForID(l << 4 | j1).getString("Name");
