...
public class AddNewChoices extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.func_206290_a(this.field_206292_a, taggedchoicetype, taggedchoicetype1);
   }

   protected final <K> TypeRewriteRule func_206290_a(String p_206290_1_, TaggedChoiceType<K> p_206290_2_, TaggedChoiceType<?> p_206290_3_) {
