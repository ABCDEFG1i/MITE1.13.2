...
public class V0100 extends Schema {
   ...
   protected static TypeTemplate func_206605_a(Schema p_206605_0_) {
   ...
   protected static void registerEntity(Schema p_206611_0_, Map<String, Supplier<TypeTemplate>> p_206611_1_, String p_206611_2_) {
      p_206611_0_.register(p_206611_1_, p_206611_2_, () -> {
         return func_206605_a(p_206611_0_);
      });
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      p_registerEntities_1_.register(map, "Enderman", (p_206609_1_) -> {
         return DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(p_registerEntities_1_), func_206605_a(p_registerEntities_1_));
      });
      ...
      p_registerEntities_1_.register(map, "EntityHorse", (p_206612_1_) -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(p_registerEntities_1_)), "ArmorItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), func_206605_a(p_registerEntities_1_));
      });
      registerEntity(p_registerEntities_1_, map, "Rabbit");
      p_registerEntities_1_.register(map, "Villager", (p_206608_1_) -> {
         return DSL.optionalFields("Inventory", DSL.list(TypeReferences.ITEM_STACK.in(p_registerEntities_1_)), "Offers", DSL.optionalFields("Recipes", DSL.list(DSL.optionalFields("buy", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "buyB", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "sell", TypeReferences.ITEM_STACK.in(p_registerEntities_1_)))), func_206605_a(p_registerEntities_1_));
      });
