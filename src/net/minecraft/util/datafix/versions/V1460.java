...
public class V1460 extends NamespacedSchema {
   ...
   protected static void registerEntity(Schema p_206557_0_, Map<String, Supplier<TypeTemplate>> p_206557_1_, String p_206557_2_) {
      p_206557_0_.register(p_206557_1_, p_206557_2_, () -> {
         return V0100.func_206605_a(p_206557_0_);
      });
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      p_registerEntities_1_.register(map, "minecraft:donkey", (p_206533_1_) -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(p_registerEntities_1_)), "SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), V0100.func_206605_a(p_registerEntities_1_));
      });
      ...
      p_registerEntities_1_.register(map, "minecraft:enderman", (p_206523_1_) -> {
         return DSL.optionalFields("carriedBlockState", TypeReferences.BLOCK_STATE.in(p_registerEntities_1_), V0100.func_206605_a(p_registerEntities_1_));
      });
      ...
      p_registerEntities_1_.register(map, "minecraft:horse", (p_206545_1_) -> {
         return DSL.optionalFields("ArmorItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), V0100.func_206605_a(p_registerEntities_1_));
      });
      ...
      p_registerEntities_1_.register(map, "minecraft:llama", (p_209327_1_) -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(p_registerEntities_1_)), "SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "DecorItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), V0100.func_206605_a(p_registerEntities_1_));
      });
      ...
      p_registerEntities_1_.register(map, "minecraft:skeleton_horse", (p_206516_1_) -> {
         return DSL.optionalFields("SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), V0100.func_206605_a(p_registerEntities_1_));
      });
      ...
      p_registerEntities_1_.register(map, "minecraft:villager", (p_206534_1_) -> {
         return DSL.optionalFields("Inventory", DSL.list(TypeReferences.ITEM_STACK.in(p_registerEntities_1_)), "Offers", DSL.optionalFields("Recipes", DSL.list(DSL.optionalFields("buy", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "buyB", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), "sell", TypeReferences.ITEM_STACK.in(p_registerEntities_1_)))), V0100.func_206605_a(p_registerEntities_1_));
      });
