...
public class V0705 extends NamespacedSchema {
   ...
   protected static void registerEntity(Schema p_206596_0_, Map<String, Supplier<TypeTemplate>> p_206596_1_, String p_206596_2_) {
      p_206596_0_.register(p_206596_1_, p_206596_2_, () -> {
         return V0100.func_206605_a(p_206596_0_);
      });
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      p_registerEntities_1_.register(map, "minecraft:enderman", (p_206567_1_) -> {
         return DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(p_registerEntities_1_), V0100.func_206605_a(p_registerEntities_1_));
      });
