...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   public static ResourceLocation func_195828_a(String p_195828_0_, char p_195828_1_) {
      return new ResourceLocation(func_195823_b(p_195828_0_, p_195828_1_));
   }

   @Nullable
   public static ResourceLocation makeResourceLocation(String p_208304_0_) {
      try {
   ...
   public static ResourceLocation read(StringReader p_195826_0_) throws CommandSyntaxException {
      ...
      try {
         ...
         throw field_200118_c.createWithContext(p_195826_0_);
      }
   }
