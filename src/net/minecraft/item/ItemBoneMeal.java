...
public class ItemBoneMeal extends ItemDye {
   public ItemBoneMeal(EnumDyeColor p_i48525_1_, Item.Properties p_i48525_2_) {
      super(p_i48525_1_, p_i48525_2_);
   }
   ...
   public EnumActionResult onItemUse(ItemUseContext p_195939_1_) {
      ...
      if (applyBonemeal(p_195939_1_.getItem(), world, blockpos)) {
         if (!world.isRemote) {
         ...
         if (flag && func_203173_b(p_195939_1_.getItem(), world, blockpos1, p_195939_1_.getFace())) {
            if (!world.isRemote) {
   ...
   public static boolean func_203173_b(ItemStack p_203173_0_, World p_203173_1_, BlockPos p_203173_2_, @Nullable EnumFacing p_203173_3_) {
   ...
   public static void spawnBonemealParticles(IWorld p_195965_0_, BlockPos p_195965_1_, int p_195965_2_) {
      ...
      IBlockState iblockstate = p_195965_0_.getBlockState(p_195965_1_);
      if (!iblockstate.isAir()) {
         for(int i = 0; i < p_195965_2_; ++i) {
            double d0 = random.nextGaussian() * 0.02D;
            double d1 = random.nextGaussian() * 0.02D;
            double d2 = random.nextGaussian() * 0.02D;
            p_195965_0_.spawnParticle(Particles.HAPPY_VILLAGER, (double)((float)p_195965_1_.getX() + random.nextFloat()), (double)p_195965_1_.getY() + (double)random.nextFloat() * iblockstate.getShape(p_195965_0_, p_195965_1_).getEnd(EnumFacing.Axis.Y), (double)((float)p_195965_1_.getZ() + random.nextFloat()), d0, d1, d2);
         }
