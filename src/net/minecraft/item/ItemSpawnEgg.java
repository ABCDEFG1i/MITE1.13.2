...
public class ItemSpawnEgg extends Item {
   ...
   public ItemSpawnEgg(EntityType<?> p_i48465_1_, int p_i48465_2_, int p_i48465_3_, Item.Properties p_i48465_4_) {
      super(p_i48465_4_);
   ...
   public ActionResult<ItemStack> onItemRightClick(World p_77659_1_, EntityPlayer p_77659_2_, EnumHand p_77659_3_) {
      ...
      if (p_77659_1_.isRemote) {
         ...
         if (raytraceresult != null && raytraceresult.type == RayTraceResult.Type.BLOCK) {
            ...
            if (!(p_77659_1_.getBlockState(blockpos).getBlock() instanceof BlockFlowingFluid)) {
               return new ActionResult<>(EnumActionResult.PASS, itemstack);
            } else if (p_77659_1_.isBlockModifiable(p_77659_2_, blockpos) && p_77659_2_.canPlayerEdit(blockpos, raytraceresult.sideHit, itemstack)) {
               EntityType<?> entitytype = this.getType(itemstack.getTag());
               if (entitytype != null && entitytype.spawnEntity(p_77659_1_, itemstack, p_77659_2_, blockpos, false, false) != null) {
   ...
   public EntityType<?> getType(@Nullable NBTTagCompound p_208076_1_) {
      if (p_208076_1_ != null && p_208076_1_.hasKey("EntityTag", 10)) {
         NBTTagCompound nbttagcompound = p_208076_1_.getCompoundTag("EntityTag");
