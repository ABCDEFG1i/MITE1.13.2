...
public class RecipeItemHelper {
   ...
   public void accountStack(ItemStack p_194112_1_) {
      if (!p_194112_1_.isEmpty()) {
         int i = pack(p_194112_1_);
   ...
   public static int pack(ItemStack p_194113_0_) {
      return IRegistry.field_212630_s.func_148757_b(p_194113_0_.getItem());
   }
   ...
   public int tryTake(int p_194122_1_, int p_194122_2_) {
      int i = this.itemToCount.get(p_194122_1_);
      if (i >= p_194122_2_) {
         this.itemToCount.put(p_194122_1_, i - p_194122_2_);
         return p_194122_1_;
      } else {
         return 0;
      }
   ...
   class RecipePicker {
               ...
               if (flag1 && list.get(i1).hasNoMatchingItems()) {
                  ...
                  for(int j1 = 0; j1 < this.possessedIngredientStackCount; ++j1) {
                     if (this.hasResidual(false, l, j1)) {
                        ...
                        RecipeItemHelper.this.increment(this.possessedIngredientStacks[j1], p_194092_1_);
                        if (flag1) {
                           p_194092_2_.add(this.possessedIngredientStacks[j1]);
                        }
                     }
                  }
      ...
      private boolean dfs(int p_194098_1_) {
         ...
         for(int j = 0; j < i; ++j) {
            if (RecipeItemHelper.this.itemToCount.get(this.possessedIngredientStacks[j]) >= p_194098_1_) {
               this.visit(false, j);
