...
public class ServerRecipePlacer implements IRecipePlacer<Integer> {
   ...
   public void place(EntityPlayerMP p_194327_1_, @Nullable IRecipe p_194327_2_, boolean p_194327_3_) {
      if (p_194327_2_ != null && p_194327_1_.getRecipeBook().isUnlocked(p_194327_2_)) {
         this.playerInventory = p_194327_1_.inventory;
         this.recipeBookContainer = (ContainerRecipeBook)p_194327_1_.openContainer;
   ...
   protected void giveToPlayer(int p_201510_1_) {
      ItemStack itemstack = this.recipeBookContainer.getSlot(p_201510_1_).getStack();
      if (!itemstack.isEmpty()) {
         for(; itemstack.getCount() > 0; this.recipeBookContainer.getSlot(p_201510_1_).decrStackSize(1)) {
   ...
   protected void tryPlaceRecipe(IRecipe p_201508_1_, boolean p_201508_2_) {
      ...
      int j1 = this.getMaxAmount(p_201508_2_, i, flag);
   ...
   public void setSlotContents(Iterator<Integer> p_201500_1_, int p_201500_2_, int p_201500_3_, int p_201500_4_, int p_201500_5_) {
      Slot slot = this.recipeBookContainer.getSlot(p_201500_2_);
      ItemStack itemstack = RecipeItemHelper.unpack(p_201500_1_.next());
      if (!itemstack.isEmpty()) {
   ...
   protected void consumeIngredient(Slot p_194325_1_, ItemStack p_194325_2_) {
      int i = this.playerInventory.findSlotMatchingUnusedItem(p_194325_2_);
      if (i != -1) {
