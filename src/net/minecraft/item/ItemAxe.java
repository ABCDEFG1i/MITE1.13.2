...
public class ItemAxe extends ItemTool {
   ...
   protected ItemAxe(int maxUses,IItemTier itemTier, float attackDamage, float attackSpeed, Item.Properties properties) {
      super(maxUses,attackDamage, attackSpeed, itemTier, EFFECTIVE_ON, properties);
   }
   ...
   public float getDestroySpeed(ItemStack p_150893_1_, IBlockState p_150893_2_) {
      ...
      return material != Material.WOOD && material != Material.PLANTS && material != Material.VINE ? super.getDestroySpeed(p_150893_1_, p_150893_2_) : this.efficiency;
   }
