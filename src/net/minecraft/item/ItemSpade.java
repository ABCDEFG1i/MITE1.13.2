...
public class ItemSpade extends ItemTool {
   ...
   public ItemSpade(IItemTier itemTier, float attackDamage, float attackSpeed, Item.Properties p_i48469_4_) {
      super(attackDamage, attackSpeed, itemTier, EFFECTIVE_ON, p_i48469_4_);
   }
