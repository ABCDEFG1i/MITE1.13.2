...
public class PathFinder {
   ...
   @Nullable
   public Path findPath(IBlockReader p_186333_1_, EntityLiving p_186333_2_, Entity p_186333_3_, float p_186333_4_) {
   ...
   @Nullable
   public Path findPath(IBlockReader p_186336_1_, EntityLiving p_186336_2_, BlockPos p_186336_3_, float p_186336_4_) {
   ...
   @Nullable
   private Path findPath(IBlockReader p_186334_1_, EntityLiving p_186334_2_, double p_186334_3_, double p_186334_5_, double p_186334_7_, float p_186334_9_) {
      this.path.clearPath();
      this.nodeProcessor.init(p_186334_1_, p_186334_2_);
   ...
   private Path findPath(PathPoint p_186335_1_, PathPoint p_186335_2_, float p_186335_3_) {
      ...
      if (pathpoint == p_186335_1_) {
         ...
         Path path = this.createPath(p_186335_1_, pathpoint);
         return path;
      }
   }

   private Path createPath(PathPoint p_75853_1_, PathPoint p_75853_2_) {
      int i = 1;
