...
public class ChannelLWJGL3 extends Channel {
   ...
   public ChannelLWJGL3(int p_i48110_1_, IntBuffer p_i48110_2_) {
      super(p_i48110_1_);
      this.libraryType = LibraryLWJGL3.class;
      this.buffer = p_i48110_2_;
   }
   ...
   public boolean attachSoundBuffer(IntBuffer p_195847_1_) {
      if (this.errorCheck(this.channelType != 0, "Sound buffers may only be attached to normal sources.")) {
         return false;
      } else {
         AL10.alSourcei(this.buffer.get(0), 4105, p_195847_1_.get(0));
   ...
   public void setFormatAndSampleRate(int p_195848_1_, int p_195848_2_) {
      this.bufferFormat = p_195848_1_;
      this.sampleRate = p_195848_2_;
   }
   ...
   public float getPlayTimeMs(int p_195850_1_) {
      return (float)(1000 * AL10.alGetBufferi(p_195850_1_, 8196) / AL10.alGetBufferi(p_195850_1_, 8195)) / ((float)AL10.alGetBufferi(p_195850_1_, 8194) / 8.0F) / (float)this.sampleRate;
   }
