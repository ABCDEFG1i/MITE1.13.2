...
public class ItemColors {
   ...
   public static ItemColors init(BlockColors p_186729_0_) {
      ...
      itemcolors.register((p_210241_0_, p_210241_1_) -> {
         if (p_210241_1_ != 1) {
            ...
            int[] aint = nbttagcompound != null && nbttagcompound.hasKey("Colors", 11) ? nbttagcompound.getIntArray("Colors") : null;
            if (aint == null) {
               return 9079434;
      ...
      itemcolors.register((p_210235_1_, p_210235_2_) -> {
         ...
         return p_186729_0_.getColor(iblockstate, (IWorldReaderBase)null, (BlockPos)null, p_210235_2_);
   ...
   public int getColor(ItemStack p_186728_1_, int p_186728_2_) {
      IItemColor iitemcolor = this.colors.getByValue(IRegistry.field_212630_s.func_148757_b(p_186728_1_.getItem()));
