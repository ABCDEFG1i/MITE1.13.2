...
public class GlDebugTextUtils {
   ...
   public static void setDebugVerbosity(int p_209247_0_) {
      if (p_209247_0_ > 0) {
         ...
         if (glcapabilities.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(Util.make(GLDebugMessageCallback.create(GlDebugTextUtils::logDebugMessage), LWJGLMemoryUntracker::untrack), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(Util.make(GLDebugMessageARBCallback.create(GlDebugTextUtils::logDebugMessage), LWJGLMemoryUntracker::untrack), 0L);
         }
