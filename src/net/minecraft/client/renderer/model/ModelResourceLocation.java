...
public class ModelResourceLocation extends ResourceLocation {
   ...
   protected ModelResourceLocation(String[] p_i48111_1_) {
      super(p_i48111_1_);
      this.field_177519_c = p_i48111_1_[2].toLowerCase(Locale.ROOT);
   }

   public ModelResourceLocation(String p_i46079_1_) {
      this(func_177517_b(p_i46079_1_));
   }
   ...
   public ModelResourceLocation(String p_i46081_1_, String p_i46081_2_) {
      this(func_177517_b(p_i46081_1_ + '#' + p_i46081_2_));
   }
   ...
   protected static String[] func_177517_b(String p_177517_0_) {
      ...
      System.arraycopy(ResourceLocation.func_195823_b(s, ':'), 0, astring, 0, 2);
      return astring;
   }
