...
public class TileEntityItemStackRenderer {
   ...
   public void renderByItem(ItemStack p_179022_1_) {
      Item item = p_179022_1_.getItem();
      if (item instanceof ItemBanner) {
         this.banner.loadFromItemStack(p_179022_1_, ((ItemBanner)item).getColor());
         ...
         if (p_179022_1_.getChildTag("BlockEntityTag") != null) {
            this.banner.loadFromItemStack(p_179022_1_, ItemShield.getColor(p_179022_1_));
         ...
         if (p_179022_1_.hasTag()) {
            NBTTagCompound nbttagcompound = p_179022_1_.getTag();
   ...
   private void renderEffect(Runnable p_211271_1_) {
      ...
      ItemRenderer.renderEffect(Minecraft.getInstance().getTextureManager(), p_211271_1_, 1);
   }
}
