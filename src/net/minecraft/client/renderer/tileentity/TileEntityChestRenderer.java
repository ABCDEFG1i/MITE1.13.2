...
public class TileEntityChestRenderer<T extends TileEntity & IChestLid> extends TileEntityRenderer<T> {
   ...
   public void render(T p_199341_1_, double p_199341_2_, double p_199341_4_, double p_199341_6_, float p_199341_8_, int p_199341_9_) {
      ...
      IBlockState iblockstate = p_199341_1_.hasWorld() ? p_199341_1_.getBlockState() : Blocks.CHEST.getDefaultState().with(BlockChest.FACING, EnumFacing.SOUTH);
      ...
      if (chesttype != ChestType.LEFT) {
         ...
         ModelChest modelchest = this.func_199347_a(p_199341_1_, p_199341_9_, flag);
         if (p_199341_9_ >= 0) {
         ...
         this.func_199346_a(p_199341_1_, p_199341_8_, modelchest);
