...
public class RenderFish extends Render<EntityFishHook> {
   ...
   public void doRender(EntityFishHook p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      if (entityplayer != null && !this.renderOutlines) {
         ...
         float f9 = (entityplayer.prevRenderYawOffset + (entityplayer.renderYawOffset - entityplayer.prevRenderYawOffset) * p_76986_9_) * ((float)Math.PI / 180F);
         ...
         if ((this.renderManager.options == null || this.renderManager.options.thirdPersonView <= 0) && entityplayer == Minecraft.getInstance().player) {
            ...
            vec3d = vec3d.rotatePitch(-(entityplayer.prevRotationPitch + (entityplayer.rotationPitch - entityplayer.prevRotationPitch) * p_76986_9_) * ((float)Math.PI / 180F));
            vec3d = vec3d.rotateYaw(-(entityplayer.prevRotationYaw + (entityplayer.rotationYaw - entityplayer.prevRotationYaw) * p_76986_9_) * ((float)Math.PI / 180F));
         ...
         double d14 = p_76986_1_.prevPosY + (p_76986_1_.posY - p_76986_1_.prevPosY) * (double)p_76986_9_ + 0.25D;
         ...
         for(int i1 = 0; i1 <= 16; ++i1) {
            ...
            bufferbuilder.pos(p_76986_2_ + d10 * (double)f10, p_76986_4_ + d11 * (double)(f10 * f10 + f10) * 0.5D + 0.25D, p_76986_6_ + d12 * (double)f10).color(0, 0, 0, 255).endVertex();
         }
