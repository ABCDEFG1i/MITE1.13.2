...
public class ModelVillager extends ModelBase {
   ...
   public ModelVillager(float p_i1164_1_, float p_i1164_2_, int p_i1164_3_, int p_i1164_4_) {
      ...
      this.villagerArms.setTextureOffset(44, 22).func_205345_a(4.0F, -2.0F, -2.0F, 4, 8, 4, p_i1164_1_, true);
   ...
   public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      this.villagerHead.rotateAngleY = p_78087_4_ * ((float)Math.PI / 180F);
      this.villagerHead.rotateAngleX = p_78087_5_ * ((float)Math.PI / 180F);
