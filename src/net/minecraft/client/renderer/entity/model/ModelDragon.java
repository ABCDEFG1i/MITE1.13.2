...
public class ModelDragon extends ModelBase {
   ...
   public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         this.spine.rotateAngleX = f9 + entitydragon.getHeadPartYOffset(i, adouble, adouble1) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
      ...
      this.head.rotateAngleY = this.updateRotations(adouble2[0] - adouble[0]) * ((float)Math.PI / 180F);
      this.head.rotateAngleX = this.updateRotations((double)entitydragon.getHeadPartYOffset(6, adouble, adouble2)) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
      this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - (double)f7) * ((float)Math.PI / 180F);
