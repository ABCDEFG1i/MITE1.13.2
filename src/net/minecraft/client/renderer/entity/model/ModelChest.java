...
public class ModelChest extends ModelBase {
   protected ModelRenderer chestLid = (new ModelRenderer(this, 0, 0)).setTextureSize(64, 64);
   protected ModelRenderer chestBelow;
   protected ModelRenderer chestKnob;
