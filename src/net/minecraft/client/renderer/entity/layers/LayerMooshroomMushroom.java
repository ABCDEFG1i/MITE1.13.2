...
public class LayerMooshroomMushroom implements LayerRenderer<EntityMooshroom> {
   ...
   public void doRenderLayer(EntityMooshroom p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
      if (!p_177141_1_.isChild() && !p_177141_1_.isInvisible()) {
         ...
         GlStateManager.popMatrix();
         GlStateManager.pushMatrix();
         this.mooshroomRenderer.getMainModel().func_205063_a().postRender(0.0625F);
         GlStateManager.scalef(1.0F, -1.0F, 1.0F);
