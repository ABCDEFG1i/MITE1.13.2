...
public class RenderArmorStand extends RenderLivingBase<EntityArmorStand> {
   ...
   protected ResourceLocation getEntityTexture(EntityArmorStand p_110775_1_) {
   ...
   protected void applyRotations(EntityArmorStand p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
      GlStateManager.rotatef(180.0F - p_77043_3_, 0.0F, 1.0F, 0.0F);
      float f = (float)(p_77043_1_.world.getTotalWorldTime() - p_77043_1_.punchCooldown) + p_77043_4_;
      if (f < 5.0F) {
   ...
   protected boolean canRenderName(EntityArmorStand p_177070_1_) {
      return p_177070_1_.isCustomNameVisible();
   }

   public void doRender(EntityArmorStand p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
