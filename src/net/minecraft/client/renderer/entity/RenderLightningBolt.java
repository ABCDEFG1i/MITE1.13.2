         ...
         for(int j = 0; j < 3; ++j) {
            ...
            for(int i1 = k; i1 >= l; --i1) {
               ...
               for(int j1 = 0; j1 < 5; ++j1) {
                  double d8 = p_76986_2_ - d6;
                  double d9 = p_76986_6_ - d6;
                  if (j1 == 1 || j1 == 2) {
                     d8 += d6 * 2.0D;
                  }
                  ...
                  double d10 = p_76986_2_ - d7;
                  double d11 = p_76986_6_ - d7;
                  if (j1 == 1 || j1 == 2) {
                     d10 += d7 * 2.0D;
                  }
                  ...
                  bufferbuilder.pos(d10 + d2, p_76986_4_ + (double)(i1 * 16), d11 + d3).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
                  bufferbuilder.pos(d8 + d4, p_76986_4_ + (double)((i1 + 1) * 16), d9 + d5).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
               }
