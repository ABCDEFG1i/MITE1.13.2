...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer {
   ...
   public void render(float p_190060_1_, long p_190060_2_) {
      ...
      for(BlockPos blockpos : iterable) {
         IBlockState iblockstate = iblockreader.getBlockState(blockpos);
         if (iblockstate.getBlock() != Blocks.AIR) {
            VoxelShape voxelshape = iblockstate.getShape(iblockreader, blockpos);

            for(AxisAlignedBB axisalignedbb : voxelshape.toBoundingBoxList()) {
               AxisAlignedBB axisalignedbb1 = axisalignedbb.offset(blockpos).grow(0.002D).offset(-d0, -d1, -d2);
               ...
               float f2 = 0.0F;
               float f3 = 0.5F;
               if (iblockstate.getBlockFaceShape(iblockreader, blockpos, EnumFacing.WEST) == BlockFaceShape.SOLID) {
               ...
               if (iblockstate.getBlockFaceShape(iblockreader, blockpos, EnumFacing.SOUTH) == BlockFaceShape.SOLID) {
               ...
               if (iblockstate.getBlockFaceShape(iblockreader, blockpos, EnumFacing.EAST) == BlockFaceShape.SOLID) {
               ...
               if (iblockstate.getBlockFaceShape(iblockreader, blockpos, EnumFacing.NORTH) == BlockFaceShape.SOLID) {
               ...
               if (iblockstate.getBlockFaceShape(iblockreader, blockpos, EnumFacing.DOWN) == BlockFaceShape.SOLID) {
               ...
               if (iblockstate.getBlockFaceShape(iblockreader, blockpos, EnumFacing.UP) == BlockFaceShape.SOLID) {
