...
public class DebugRendererLight implements DebugRenderer.IDebugRenderer {
   ...
   public DebugRendererLight(Minecraft p_i48765_1_) {
   ...
   public void render(float p_190060_1_, long p_190060_2_) {
      ...
      d0 = entityplayer.lastTickPosY + (entityplayer.posY - entityplayer.lastTickPosY) * (double)p_190060_1_;
      d0 = entityplayer.lastTickPosZ + (entityplayer.posZ - entityplayer.lastTickPosZ) * (double)p_190060_1_;
