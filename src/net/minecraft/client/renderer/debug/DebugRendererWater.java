   ...
   public void render(float p_190060_1_, long p_190060_2_) {
      ...
      for(BlockPos blockpos1 : BlockPos.getAllInBox(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
         ...
         if (ifluidstate.isTagged(FluidTags.WATER)) {
            ...
            WorldRenderer.func_189696_b((new AxisAlignedBB((double)((float)blockpos1.getX() + 0.01F), (double)((float)blockpos1.getY() + 0.01F), (double)((float)blockpos1.getZ() + 0.01F), (double)((float)blockpos1.getX() + 0.99F), d0, (double)((float)blockpos1.getZ() + 0.99F))).offset(-this.xo, -this.yo, -this.zo), 1.0F, 1.0F, 1.0F, 0.2F);
         }
      }
      ...
      for(BlockPos blockpos2 : BlockPos.getAllInBox(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
         ...
         if (ifluidstate1.isTagged(FluidTags.WATER)) {
            DebugRenderer.renderDebugText(String.valueOf(ifluidstate1.getLevel()), (double)blockpos2.getX() + 0.5D, (double)((float)blockpos2.getY() + ifluidstate1.getHeight()), (double)blockpos2.getZ() + 0.5D, p_190060_1_, -16777216);
         }
      }
