...
public class RenderSkyboxCube {
   ...
   public RenderSkyboxCube(ResourceLocation p_i49378_1_) {
      for(int i = 0; i < 6; ++i) {
         this.locations[i] = new ResourceLocation(p_i49378_1_.getNamespace(), p_i49378_1_.getPath() + '_' + i + ".png");
      }

   }

   public void render(Minecraft p_209142_1_, float p_209142_2_, float p_209142_3_) {
      Tessellator tessellator = Tessellator.getInstance();
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      GlStateManager.matrixMode(5889);
      GlStateManager.pushMatrix();
      GlStateManager.loadIdentity();
      GlStateManager.multMatrixf(Matrix4f.perspective(85.0D, (float)p_209142_1_.mainWindow.getFramebufferWidth() / (float)p_209142_1_.mainWindow.getFramebufferHeight(), 0.05F, 10.0F));
      ...
      for(int j = 0; j < 4; ++j) {
         ...
         GlStateManager.rotatef(p_209142_2_, 1.0F, 0.0F, 0.0F);
         GlStateManager.rotatef(p_209142_3_, 0.0F, 1.0F, 0.0F);

         for(int k = 0; k < 6; ++k) {
            p_209142_1_.getTextureManager().bindTexture(this.locations[k]);
