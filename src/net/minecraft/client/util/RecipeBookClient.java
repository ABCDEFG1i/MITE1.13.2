...
public class RecipeBookClient extends RecipeBook {
   ...
   private static RecipeBookCategories getCategory(IRecipe p_202887_0_) {
      if (p_202887_0_ instanceof FurnaceRecipe) {
         if (p_202887_0_.getRecipeOutput().getItem() instanceof ItemFood) {
            return RecipeBookCategories.FURNACE_FOOD;
         } else {
            return p_202887_0_.getRecipeOutput().getItem() instanceof ItemBlock ? RecipeBookCategories.FURNACE_BLOCKS : RecipeBookCategories.FURNACE_MISC;
         }
      } else {
         ItemStack itemstack = p_202887_0_.getRecipeOutput();
