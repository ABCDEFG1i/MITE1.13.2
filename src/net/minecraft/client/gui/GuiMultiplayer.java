...
public class GuiMultiplayer extends GuiScreen {
   ...
   public void createButtons() {
      ...
      this.eventListeners.add(this.serverListSelector);
   ...
   public void selectServer(int p_146790_1_) {
      this.serverListSelector.setSelectedSlotIndex(p_146790_1_);
      GuiListExtended.IGuiListEntry<?> iguilistentry = p_146790_1_ < 0 ? null : this.serverListSelector.getChildren().get(p_146790_1_);
