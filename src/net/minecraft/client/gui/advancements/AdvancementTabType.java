...
enum AdvancementTabType {
   ...
   public void draw(Gui p_192651_1_, int p_192651_2_, int p_192651_3_, boolean p_192651_4_, int p_192651_5_) {
      int i = this.textureX;
      if (p_192651_5_ > 0) {
         i += this.width;
      }
      ...
      p_192651_1_.drawTexturedModalRect(p_192651_2_ + this.getX(p_192651_5_), p_192651_3_ + this.getY(p_192651_5_), i, j, this.width, this.height);
   }
