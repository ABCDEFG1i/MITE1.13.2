...
public class GuiUtilRenderComponents {
   public static String removeTextColorsIfConfigured(String p_178909_0_, boolean p_178909_1_) {
      return !p_178909_1_ && !Minecraft.getInstance().gameSettings.chatColours ? TextFormatting.getTextWithoutFormattingCodes(p_178909_0_) : p_178909_0_;
   }
   ...
   public static List<ITextComponent> splitText(ITextComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
      ...
      for(int j = 0; j < list1.size(); ++j) {
         ...
         if (s.contains("\n")) {
            ...
            s = s.substring(0, k + 1);
            ITextComponent itextcomponent2 = (new TextComponentString(s1)).setStyle(itextcomponent1.getStyle().createShallowCopy());
         ...
         ITextComponent itextcomponent3 = (new TextComponentString(s5)).setStyle(itextcomponent1.getStyle().createShallowCopy());
         if (i + i1 > p_178908_1_) {
            ...
            if (s3 != null && !s3.isEmpty()) {
               ...
               ITextComponent itextcomponent4 = (new TextComponentString(s3)).setStyle(itextcomponent1.getStyle().createShallowCopy());
               list1.add(j + 1, itextcomponent4);
            }

            i1 = p_178908_2_.getStringWidth(s2);
            itextcomponent3 = new TextComponentString(s2);
