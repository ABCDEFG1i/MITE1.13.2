...
public class GuiSubtitleOverlay extends Gui implements ISoundEventListener {
   ...
   public void onPlaySound(ISound p_184067_1_, SoundEventAccessor p_184067_2_) {
      if (p_184067_2_.getSubtitle() != null) {
         String s = p_184067_2_.getSubtitle().getFormattedText();
         if (!this.subtitles.isEmpty()) {
            for(GuiSubtitleOverlay.Subtitle guisubtitleoverlay$subtitle : this.subtitles) {
               if (guisubtitleoverlay$subtitle.getString().equals(s)) {
                  guisubtitleoverlay$subtitle.refresh(new Vec3d((double)p_184067_1_.getX(), (double)p_184067_1_.getY(), (double)p_184067_1_.getZ()));
                  return;
               }
            }
         }

         this.subtitles.add(new GuiSubtitleOverlay.Subtitle(s, new Vec3d((double)p_184067_1_.getX(), (double)p_184067_1_.getY(), (double)p_184067_1_.getZ())));
      }
   }
