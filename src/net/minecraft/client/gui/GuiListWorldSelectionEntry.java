...
public final class GuiListWorldSelectionEntry extends GuiListExtended.IGuiListEntry<GuiListWorldSelectionEntry> implements AutoCloseable {
   ...
   public GuiListWorldSelectionEntry(GuiListWorldSelection p_i46591_1_, WorldSummary p_i46591_2_, ISaveFormat p_i46591_3_) {
      this.containingListSel = p_i46591_1_;
      this.worldSelScreen = p_i46591_1_.getGuiWorldSelection();
      this.worldSummary = p_i46591_2_;
      this.client = Minecraft.getInstance();
      this.iconLocation = new ResourceLocation("worlds/" + Hashing.sha1().hashUnencodedChars(p_i46591_2_.getFileName()) + "/icon");
