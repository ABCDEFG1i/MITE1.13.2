...
public class GuiScreenBook extends GuiScreen {
      ...
      if (this.bookIsUnsigned && this.bookIsModified) {
         if (this.bookPages != null) {
            while(this.bookPages.size() > 1) {
               String s = this.bookPages.getStringTagAt(this.bookPages.size() - 1);
               if (!s.isEmpty()) {
                  break;
               }
            ...
            this.mc.getConnection().sendPacket(new CPacketEditBook(this.book, p_146462_1_, this.field_212343_J));
         }
   ...
   private String pageGetCurrent() {
      return this.bookPages != null && this.currPage >= 0 && this.currPage < this.bookPages.size() ? this.bookPages.getStringTagAt(this.currPage) : "";
   }
      ...
      if (this.bookGettingSigned) {
         ...
         if (this.cachedComponents == null) {
            ...
            if (itextcomponent1 != null) {
               this.handleComponentHover(itextcomponent1, p_73863_1_, p_73863_2_);
            }
         }
      }
