...
public class TrueTypeGlyphProvider implements IGlyphProvider {
   ...
   protected TrueTypeGlyphProvider(STBTTFontinfo p_i49765_1_, float p_i49765_2_, float p_i49765_3_, float p_i49765_4_, float p_i49765_5_, String p_i49765_6_) {
      this.fontInfo = p_i49765_1_;
      this.oversample = p_i49765_3_;
      p_i49765_6_.chars().forEach((p_211614_1_) -> {
         this.chars.add((char)(p_211614_1_ & '\uffff'));
      });
      this.shiftX = p_i49765_4_ * p_i49765_3_;
      this.shiftY = p_i49765_5_ * p_i49765_3_;
      this.scale = STBTruetype.stbtt_ScaleForPixelHeight(p_i49765_1_, p_i49765_2_ * p_i49765_3_);
   ...
   public static class Factory implements IGlyphProviderFactory {
      ...
      public IGlyphProvider create(IResourceManager p_211246_1_) {
         try (IResource iresource = p_211246_1_.getResource(new ResourceLocation(this.file.getNamespace(), (new StringBuilder()).append("font/").append(this.file.getPath()).toString()))) {
   ...
   class GlpyhInfo implements IGlyphInfo {
      ...
      public void uploadGlyph(int p_211573_1_, int p_211573_2_) {
         try (NativeImage nativeimage = new NativeImage(NativeImage.PixelFormat.LUMINANCE, this.width, this.height, false)) {
            ...
            nativeimage.uploadTextureSub(0, p_211573_1_, p_211573_2_, 0, 0, this.width, this.height, false);
         }
