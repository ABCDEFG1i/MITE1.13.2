...
public class FontResourceManager implements IResourceManagerReloadListener {
   ...
   public void onResourceManagerReload(IResourceManager p_195410_1_) {
      ...
      for(ResourceLocation resourcelocation : p_195410_1_.getAllResourceLocations("font", (p_211506_0_) -> {
         ...
         try {
            for(IResource iresource : p_195410_1_.getAllResources(resourcelocation)) {
                  ...
                  for(int i = jsonarray.size() - 1; i >= 0; --i) {
                     ...
                     try {
                        ...
                        if (!this.forceUnicodeFont || glyphprovidertypes == GlyphProviderTypes.LEGACY_UNICODE || !resourcelocation1.equals(Minecraft.DEFAULT_FONT_RENDERER_NAME)) {
                           IGlyphProvider iglyphprovider = glyphprovidertypes.getFactory(jsonobject).create(p_195410_1_);
   ...
   public FontRenderer getFontRenderer(ResourceLocation p_211504_1_) {
      return this.fontRenderers.computeIfAbsent(p_211504_1_, (p_212318_1_) -> {
   ...
   public void setForceUnicodeFont(boolean p_211825_1_) {
      if (p_211825_1_ != this.forceUnicodeFont) {
         this.forceUnicodeFont = p_211825_1_;
