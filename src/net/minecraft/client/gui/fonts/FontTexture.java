...
public class FontTexture extends AbstractTexture implements Closeable {
   ...
   public FontTexture(ResourceLocation p_i49770_1_, boolean p_i49770_2_) {
      ...
      TextureUtil.func_211681_a(p_i49770_2_ ? NativeImage.PixelFormatGLCode.RGBA : NativeImage.PixelFormatGLCode.INTENSITY, this.getGlTextureId(), 256, 256);
   }
   ...
   public TexturedGlyph createTexturedGlyph(IGlyphInfo p_211131_1_) {
      if (p_211131_1_.isColored() != this.colored) {
         ...
         if (fonttexture$entry != null) {
            this.bindTexture();
            p_211131_1_.uploadGlyph(fonttexture$entry.xOffset, fonttexture$entry.yOffset);
            float f = 256.0F;
            float f1 = 256.0F;
            float f2 = 0.01F;
            return new TexturedGlyph(this.textureLocation, ((float)fonttexture$entry.xOffset + 0.01F) / 256.0F, ((float)fonttexture$entry.xOffset - 0.01F + (float)p_211131_1_.getWidth()) / 256.0F, ((float)fonttexture$entry.yOffset + 0.01F) / 256.0F, ((float)fonttexture$entry.yOffset - 0.01F + (float)p_211131_1_.getHeight()) / 256.0F, p_211131_1_.func_211198_f(), p_211131_1_.func_211199_g(), p_211131_1_.func_211200_h(), p_211131_1_.func_211204_i());
         } else {
            return null;
         }
      }
