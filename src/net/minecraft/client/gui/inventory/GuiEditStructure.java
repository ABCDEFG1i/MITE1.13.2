...
public class GuiEditStructure extends GuiScreen {
   ...
   protected void initGui() {
      ...
      this.eventListeners.addAll(this.tabOrder);
   ...
   private void updateMirrorButton() {
      ...
      case LEFT_RIGHT:
         ...
         break;
      case FRONT_BACK:
         this.mirrorButton.displayString = "^ YELLOW";
      }
   ...
   public void render(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if (structuremode == StructureMode.LOAD || structuremode == StructureMode.SAVE) {
         ...
         this.posXEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
         this.posYEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
         this.posZEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
      ...
      if (structuremode == StructureMode.SAVE) {
         ...
         this.sizeXEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
         this.sizeYEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
         this.sizeZEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
      ...
      if (structuremode == StructureMode.LOAD) {
         ...
         this.integrityEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
         this.seedEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
      ...
      if (structuremode == StructureMode.DATA) {
         ...
         this.dataEdit.drawTextField(p_73863_1_, p_73863_2_, p_73863_3_);
      }
