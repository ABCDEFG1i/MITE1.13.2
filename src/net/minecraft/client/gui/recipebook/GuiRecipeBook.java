...
public class GuiRecipeBook extends Gui implements IGuiEventListener, IRecipeUpdateListener, IRecipePlacer<Ingredient> {
   ...
   public void render(int p_191861_1_, int p_191861_2_, float p_191861_3_) {
      if (this.isVisible()) {
         ...
         this.searchBar.drawTextField(p_191861_1_, p_191861_2_, p_191861_3_);
         RenderHelper.disableStandardItemLighting();

         for(GuiButtonRecipeTab guibuttonrecipetab : this.recipeTabs) {
            guibuttonrecipetab.render(p_191861_1_, p_191861_2_, p_191861_3_);
         }

         this.toggleRecipesBtn.render(p_191861_1_, p_191861_2_, p_191861_3_);
   ...
   public void setSlotContents(Iterator<Ingredient> p_201500_1_, int p_201500_2_, int p_201500_3_, int p_201500_4_, int p_201500_5_) {
      ...
      if (!ingredient.hasNoMatchingItems()) {
         Slot slot = this.field_201522_g.inventorySlots.get(p_201500_2_);
