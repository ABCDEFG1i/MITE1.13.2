...
public class GuiRecipeOverlay extends Gui implements IGuiEventListener {
   ...
   class Button extends GuiButton implements IRecipePlacer<Ingredient> {
      ...
      public void setSlotContents(Iterator<Ingredient> p_201500_1_, int p_201500_2_, int p_201500_3_, int p_201500_4_, int p_201500_5_) {
         ItemStack[] aitemstack = p_201500_1_.next().getMatchingStacks();
         if (aitemstack.length != 0) {
            this.field_201506_o.add(new GuiRecipeOverlay.Button.Child(3 + p_201500_5_ * 7, 3 + p_201500_4_ * 7, aitemstack));
         }
