...
public class ServerListEntryNormal extends ServerSelectionList.Entry {
   ...
   protected ServerListEntryNormal(GuiMultiplayer p_i45048_1_, ServerData p_i45048_2_) {
      ...
      this.serverIcon = new ResourceLocation("servers/" + Hashing.sha1().hashUnencodedChars(p_i45048_2_.serverIP) + "/icon");
   ...
   public void drawEntry(int p_194999_1_, int p_194999_2_, int p_194999_3_, int p_194999_4_, boolean p_194999_5_, float p_194999_6_) {
      ...
      List<String> list = this.mc.fontRenderer.listFormattedStringToWidth(this.server.serverMOTD, p_194999_1_ - 32 - 2);
      ...
      this.mc.fontRenderer.drawString(s2, (float)(j + p_194999_1_ - l - 15 - 2), (float)(i + 1), 8421504);
      int i1 = 0;
      String s = null;
      int j1;
      String s1;
      ...
      Gui.drawModalRectWithCustomSizedTexture(j + p_194999_1_ - 15, i, (float)(i1 * 10), (float)(176 + j1 * 8), 10, 8, 256.0F, 256.0F);
