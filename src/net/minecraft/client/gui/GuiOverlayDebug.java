...
public class GuiOverlayDebug extends Gui {
   ...
   protected List<String> func_209011_c() {
      ...
      if (this.mc.isReducedDebug()) {
         return Lists.newArrayList("Minecraft 1.13.2 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, s, this.mc.renderGlobal.func_72735_c(), this.mc.renderGlobal.func_72723_d(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.world.getDebugLoadedEntities(), this.mc.world.getProviderName(), "", String.format("Chunk-relative: %d %d %d", blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15));
      } else {
         Entity entity = this.mc.getRenderViewEntity();
         ...
         if (this.mc.world != null) {
            ...
            if (this.mc.world.isBlockLoaded(blockpos) && blockpos.getY() >= 0 && blockpos.getY() < 256) {
               if (!chunk.isEmpty()) {
                  ...
                  list.add(String.format(Locale.ROOT, "Local Difficulty: %.2f // %.2f (Day %d)", difficultyinstance.getAdditionalDifficulty(), difficultyinstance.getClampedAdditionalDifficulty(), this.mc.world.getWorldTime() / 24000L));
               } else {
         ...
         if (this.field_211537_g != null && this.field_211537_g.type == RayTraceResult.Type.BLOCK) {
            BlockPos blockpos1 = this.field_211537_g.getBlockPos();
         ...
         if (this.field_211538_h != null && this.field_211538_h.type == RayTraceResult.Type.BLOCK) {
            BlockPos blockpos2 = this.field_211538_h.getBlockPos();
   ...
   protected List<String> getDebugInfoRight() {
      ...
      if (this.mc.isReducedDebug()) {
         ...
         if (this.field_211537_g != null && this.field_211537_g.type == RayTraceResult.Type.BLOCK) {
            BlockPos blockpos = this.field_211537_g.getBlockPos();
            IBlockState iblockstate = this.mc.world.getBlockState(blockpos);
            list.add("");
            list.add(TextFormatting.UNDERLINE + "Targeted Block");
            list.add(String.valueOf((Object)IRegistry.field_212618_g.func_177774_c(iblockstate.getBlock())));
         ...
         if (this.field_211538_h != null && this.field_211538_h.type == RayTraceResult.Type.BLOCK) {
            BlockPos blockpos1 = this.field_211538_h.getBlockPos();
            IFluidState ifluidstate = this.mc.world.getFluidState(blockpos1);
            list.add("");
            list.add(TextFormatting.UNDERLINE + "Targeted Fluid");
            list.add(String.valueOf((Object)IRegistry.field_212619_h.func_177774_c(ifluidstate.getFluid())));
         ...
         if (entity != null) {
            ...
            list.add(String.valueOf((Object)IRegistry.field_212629_r.func_177774_c(entity.getType())));
         }
