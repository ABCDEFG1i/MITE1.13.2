...
public class NetHandlerLoginClient implements INetHandlerLoginClient {
   ...
   public void handleEncryptionRequest(SPacketEncryptionRequest p_147389_1_) {
      ...
      CPacketEncryptionResponse cpacketencryptionresponse = new CPacketEncryptionResponse(secretkey, publickey, p_147389_1_.getVerifyToken());
   ...
   public void handleLoginSuccess(SPacketLoginSuccess p_147390_1_) {
   ...
   public void onDisconnect(ITextComponent p_147231_1_) {
      if (this.previousGuiScreen != null && this.previousGuiScreen instanceof GuiScreenRealmsProxy) {
         this.mc.displayGuiScreen((new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.previousGuiScreen).getProxy(), "connect.failed", p_147231_1_)).getProxy());
      } else {
         this.mc.displayGuiScreen(new GuiDisconnected(this.previousGuiScreen, "connect.failed", p_147231_1_));
      }

   }

   public void handleDisconnect(SPacketDisconnectLogin p_147388_1_) {
      this.networkManager.closeChannel(p_147388_1_.getReason());
   }

   public void handleEnableCompression(SPacketEnableCompression p_180464_1_) {
