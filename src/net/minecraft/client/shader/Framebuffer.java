...
public class Framebuffer {
   ...
   public void createFramebuffer(int p_147605_1_, int p_147605_2_) {
      ...
      if (!OpenGlHelper.isFramebufferEnabled()) {
         ...
         GlStateManager.texImage2D(3553, 0, 32856, this.framebufferTextureWidth, this.framebufferTextureHeight, 0, 6408, 5121,
                 null);
   ...
   public void setFramebufferFilter(int p_147607_1_) {
      if (OpenGlHelper.isFramebufferEnabled()) {
         ...
         GlStateManager.bindTexture(this.framebufferTexture);
         GlStateManager.texParameteri(3553, 10241, p_147607_1_);
         GlStateManager.texParameteri(3553, 10240, p_147607_1_);
