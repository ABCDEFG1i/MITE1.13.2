...
public class ResourcePackListEntryFound extends GuiListExtended.IGuiListEntry<ResourcePackListEntryFound> {
   ...
   protected PackCompatibility func_195019_f() {
      return this.resourcePackEntry.func_195791_d();
   }

   protected String getResourcePackDescription() {
      return this.resourcePackEntry.func_195795_c().getFormattedText();
   }
   ...
   public void drawEntry(int p_194999_1_, int p_194999_2_, int p_194999_3_, int p_194999_4_, boolean p_194999_5_, float p_194999_6_) {
      ...
      if (!packcompatibility.func_198968_a()) {
         ...
         Gui.drawRect(j - 1, i - 1, j + p_194999_1_ - 9, i + p_194999_2_ + 1, -8978432);
      }
