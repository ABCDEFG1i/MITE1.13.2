...
public class AnimationMetadataSectionSerializer implements IMetadataSectionSerializer<AnimationMetadataSection> {
   public AnimationMetadataSection deserialize(JsonObject p_195812_1_) {
      ...
      int i = JsonUtils.getInt(p_195812_1_, "frametime", 1);
      if (i != 1) {
      ...
      if (p_195812_1_.has("frames")) {
         try {
            JsonArray jsonarray = JsonUtils.getJsonArray(p_195812_1_, "frames");
      ...
      int k = JsonUtils.getInt(p_195812_1_, "width", -1);
      int l = JsonUtils.getInt(p_195812_1_, "height", -1);
      if (k != -1) {
      ...
      boolean flag = JsonUtils.getBoolean(p_195812_1_, "interpolate", false);
