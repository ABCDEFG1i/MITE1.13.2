...
public class ParticleDrip extends Particle {
   ...
   public int getBrightnessForRender(float p_189214_1_) {
      return this.field_204502_a.isIn(FluidTags.WATER) ? super.getBrightnessForRender(p_189214_1_) : 257;
   }
   ...
   public static class LavaFactory implements IParticleFactory<BasicParticleType> {
      public Particle makeParticle(BasicParticleType p_199234_1_, World p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
         return new ParticleDrip(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.LAVA);
      }
   }
   ...
   public static class WaterFactory implements IParticleFactory<BasicParticleType> {
      public Particle makeParticle(BasicParticleType p_199234_1_, World p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
         return new ParticleDrip(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, Fluids.WATER);
      }
   }
}
