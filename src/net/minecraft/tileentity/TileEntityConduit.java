...
public class TileEntityConduit extends TileEntity implements ITickable {
   ...
   public void readFromNBT(NBTTagCompound p_145839_1_) {
      ...
      if (p_145839_1_.hasKey("target_uuid")) {
         this.targetUuid = NBTUtil.getUUIDFromTag(p_145839_1_.getCompoundTag("target_uuid"));
      } else {
   ...
   public NBTTagCompound writeToNBT(NBTTagCompound p_189515_1_) {
      ...
      if (this.target != null) {
         p_189515_1_.setTag("target_uuid", NBTUtil.createUUIDTag(this.target.getUniqueID()));
      }
   ...
   private void attackMobs() {
      ...
      } else if (!this.target.isEntityAlive() || this.pos.getDistance(new BlockPos(this.target)) > 8.0D) {
         this.target = null;
      }
   ...
   @OnlyIn(Dist.CLIENT)
   public float func_205036_a(float p_205036_1_) {
      return (this.field_205043_f + p_205036_1_) * -0.0375F;
   }
