...
public class StatList {
   public static final StatType<Block> BLOCK_MINED = func_199085_a("mined", IRegistry.field_212618_g);
   public static final StatType<Item> ITEM_CRAFTED = func_199085_a("crafted", IRegistry.field_212630_s);
   public static final StatType<Item> ITEM_USED = func_199085_a("used", IRegistry.field_212630_s);
   public static final StatType<Item> ITEM_BROKEN = func_199085_a("broken", IRegistry.field_212630_s);
   public static final StatType<Item> ITEM_PICKED_UP = func_199085_a("picked_up", IRegistry.field_212630_s);
   public static final StatType<Item> ITEM_DROPPED = func_199085_a("dropped", IRegistry.field_212630_s);
   public static final StatType<EntityType<?>> ENTITY_KILLED = func_199085_a("killed", IRegistry.field_212629_r);
   public static final StatType<EntityType<?>> ENTITY_KILLED_BY = func_199085_a("killed_by", IRegistry.field_212629_r);
   public static final StatType<ResourceLocation> CUSTOM = func_199085_a("custom", IRegistry.field_212623_l);
   ...
   private static ResourceLocation registerCustom(String p_199084_0_, IStatFormater p_199084_1_) {
      ResourceLocation resourcelocation = new ResourceLocation(p_199084_0_);
      IRegistry.field_212623_l.func_82595_a(resourcelocation, resourcelocation);
      CUSTOM.func_199077_a(resourcelocation, p_199084_1_);
      return resourcelocation;
   }

   private static <T> StatType<T> func_199085_a(String p_199085_0_, IRegistry<T> p_199085_1_) {
      StatType<T> stattype = new StatType<>(p_199085_1_);
      IRegistry.field_212634_w.func_82595_a(new ResourceLocation(p_199085_0_), stattype);
      return stattype;
   }
}
