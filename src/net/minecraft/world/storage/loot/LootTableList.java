...
public class LootTableList {
   ...
   public static final ResourceLocation ENTITIES_SNOWMAN = register("entities/snow_golem");
   ...
   public static final ResourceLocation ENTITIES_PHANTOM = register("entities/phantom");
   ...
   public static final ResourceLocation ENTITIES_EVOCATION_ILLAGER = register("entities/evoker");
   public static final ResourceLocation ENTITIES_VINDICATION_ILLAGER = register("entities/vindicator");
   ...
   public static final ResourceLocation ENTITIES_PUFFERFISH = register("entities/pufferfish");
   ...
   public static final ResourceLocation ENTITIES_TURTLE = register("entities/turtle");
   public static final ResourceLocation ENTITIES_SALMON = register("entities/salmon");
   public static final ResourceLocation ENTITIES_COD = register("entities/cod");
   public static final ResourceLocation ENTITIES_TROPICAL_FISH = register("entities/tropical_fish");
   public static final ResourceLocation ENTITIES_DROWNED = register("entities/drowned");
   public static final ResourceLocation ENTITIES_DOLPHIN = register("entities/dolphin");
   ...
   public static ResourceLocation register(ResourceLocation p_186375_0_) {
