...
public abstract class LootEntry {
   ...
   protected LootEntry(int p_i46642_1_, int p_i46642_2_, LootCondition[] p_i46642_3_) {
      this.weight = p_i46642_1_;
      this.quality = p_i46642_2_;
      this.conditions = p_i46642_3_;
   }

   public int getEffectiveWeight(float p_186361_1_) {
      return Math.max(MathHelper.floor((float)this.weight + (float)this.quality * p_186361_1_), 0);
   }

   public abstract void addLoot(Collection<ItemStack> p_186363_1_, Random p_186363_2_, LootContext p_186363_3_);

   protected abstract void serialize(JsonObject p_186362_1_, JsonSerializationContext p_186362_2_);
