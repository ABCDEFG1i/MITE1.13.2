...
public class LootTableManager implements IResourceManagerReloadListener {
   ...
   public LootTable getLootTableFromLocation(ResourceLocation p_186521_1_) {
      return this.registeredLootTables.getOrDefault(p_186521_1_, LootTable.EMPTY_LOOT_TABLE);
   }

   public void onResourceManagerReload(IResourceManager p_195410_1_) {
      this.registeredLootTables.clear();

      for(ResourceLocation resourcelocation : p_195410_1_.getAllResourceLocations("loot_tables", (p_195434_0_) -> {
         ...
         try (IResource iresource = p_195410_1_.getResource(resourcelocation)) {
            LootTable loottable = JsonUtils.fromJson(GSON_INSTANCE, IOUtils.toString(iresource.getInputStream(), StandardCharsets.UTF_8), LootTable.class);
            if (loottable != null) {
