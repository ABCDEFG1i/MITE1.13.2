...
public class LootFunctionManager {
   ...
   public static LootFunction.Serializer<?> getSerializerForName(ResourceLocation p_186583_0_) {
      LootFunction.Serializer<?> serializer = NAME_TO_SERIALIZER_MAP.get(p_186583_0_);
      if (serializer == null) {
   ...
   public static <T extends LootFunction> LootFunction.Serializer<T> getSerializerFor(T p_186581_0_) {
      LootFunction.Serializer<T> serializer = (LootFunction.Serializer<T>)CLASS_TO_SERIALIZER_MAP.get(p_186581_0_.getClass());
      if (serializer == null) {
