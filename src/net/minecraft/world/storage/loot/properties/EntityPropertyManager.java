...
public class EntityPropertyManager {
   ...
   public static <T extends EntityProperty> EntityProperty.Serializer<T> getSerializerFor(T p_186645_0_) {
      EntityProperty.Serializer<?> serializer = CLASS_TO_SERIALIZER_MAP.get(p_186645_0_.getClass());
      if (serializer == null) {
