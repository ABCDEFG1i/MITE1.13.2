...
public class LootConditionManager {
   ...
   public static <T extends LootCondition> void registerCondition(LootCondition.Serializer<? extends T> p_186639_0_) {
      ResourceLocation resourcelocation = p_186639_0_.getLootTableLocation();
      Class<T> oclass = (Class<T>)p_186639_0_.getConditionClass();
   ...
   public static boolean testAllConditions(@Nullable LootCondition[] p_186638_0_, Random p_186638_1_, LootContext p_186638_2_) {
      if (p_186638_0_ == null) {
         return true;
      } else {
   ...
   public static LootCondition.Serializer<?> getSerializerForName(ResourceLocation p_186641_0_) {
      LootCondition.Serializer<?> serializer = NAME_TO_SERIALIZER_MAP.get(p_186641_0_);
      if (serializer == null) {
   ...
   public static <T extends LootCondition> LootCondition.Serializer<T> getSerializerFor(T p_186640_0_) {
      LootCondition.Serializer<T> serializer = (LootCondition.Serializer<T>)CLASS_TO_SERIALIZER_MAP.get(p_186640_0_.getClass());
      if (serializer == null) {
