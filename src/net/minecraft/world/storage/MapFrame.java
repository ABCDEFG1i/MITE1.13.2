...
public class MapFrame {
   ...
   public static MapFrame func_212765_a(NBTTagCompound p_212765_0_) {
      BlockPos blockpos = NBTUtil.getPosFromTag(p_212765_0_.getCompoundTag("Pos"));
      int i = p_212765_0_.getInteger("Rotation");
      int j = p_212765_0_.getInteger("EntityId");
      return new MapFrame(blockpos, i, j);
   }

   public NBTTagCompound func_212770_a() {
      NBTTagCompound nbttagcompound = new NBTTagCompound();
      nbttagcompound.setTag("Pos", NBTUtil.createPosTag(this.field_212771_a));
      nbttagcompound.setInteger("Rotation", this.field_212772_b);
      nbttagcompound.setInteger("EntityId", this.field_212773_c);
