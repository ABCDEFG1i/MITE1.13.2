...
public class DragonFightManager {
   ...
   public DragonFightManager(WorldServer p_i46669_1_, NBTTagCompound p_i46669_2_) {
      ...
      if (p_i46669_2_.hasKey("Gateways", 9)) {
         NBTTagList nbttaglist = p_i46669_2_.getTagList("Gateways", 3);
   ...
   private void generateGateway(BlockPos p_186089_1_) {
      ...
      Feature.END_GATEWAY.func_212245_a(this.world, this.world.getChunkProvider().getChunkGenerator(), new Random(), p_186089_1_, new EndGatewayConfig(false));
   }
   ...
   public void dragonUpdate(EntityDragon p_186099_1_) {
   ...
   public void onCrystalDestroyed(EntityEnderCrystal p_186090_1_, DamageSource p_186090_2_) {
      if (this.respawnState != null && this.crystals.contains(p_186090_1_)) {
         ...
         if (entity instanceof EntityDragon) {
            ((EntityDragon)entity).onCrystalDestroyed(p_186090_1_, new BlockPos(p_186090_1_), p_186090_2_);
         }
      }
   ...
   private void respawnDragon(List<EntityEnderCrystal> p_186093_1_) {
      if (this.dragonKilled && this.respawnState == null) {
