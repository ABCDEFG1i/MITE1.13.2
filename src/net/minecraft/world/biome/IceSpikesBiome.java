...
public final class IceSpikesBiome extends Biome {
   public IceSpikesBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, createCompositeFeature(Feature.ICE_SPIKE, IFeatureConfig.NO_FEATURE_CONFIG, AT_SURFACE, new FrequencyConfig(3)));
