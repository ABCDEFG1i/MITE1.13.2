...
public final class DarkForestBiome extends Biome {
   public DarkForestBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(Feature.RANDOM_FEATURE_LIST, new RandomDefaultFeatureListConfig(new Feature[]{ Feature.CANOPY_TREE, Feature.BIG_TREE}, new IFeatureConfig[]{IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG}, new float[]{0.025F, 0.05F, 0.6666667F, 0.1F}, Feature.TREE, IFeatureConfig.NO_FEATURE_CONFIG), ROOFED_TREE, IPlacementConfig.NO_PLACEMENT_CONFIG));
