...
public class NoiseGeneratorImproved extends NoiseGenerator {
   ...
   public double func_205561_a(double p_205561_1_, double p_205561_3_, double p_205561_5_) {
      ...
      return this.lerp(d5, this.lerp(d4, this.lerp(d3, this.grad(this.permutations[l1], d0, d1, d2), this.grad(this.permutations[k2], d0 - 1.0D, d1, d2)), this.lerp(d3, this.grad(this.permutations[i2], d0, d1 - 1.0D, d2), this.grad(this.permutations[l2], d0 - 1.0D, d1 - 1.0D, d2))), this.lerp(d4, this.lerp(d3, this.grad(this.permutations[l1 + 1], d0, d1, d2 - 1.0D), this.grad(this.permutations[k2 + 1], d0 - 1.0D, d1, d2 - 1.0D)), this.lerp(d3, this.grad(this.permutations[i2 + 1], d0, d1 - 1.0D, d2 - 1.0D), this.grad(this.permutations[l2 + 1], d0 - 1.0D, d1 - 1.0D, d2 - 1.0D))));
   }
