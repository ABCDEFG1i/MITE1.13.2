...
public enum GenLayerShore implements ICastleTransformer {
   ...
   private static final int BEACH = IRegistry.field_212624_m.func_148757_b(Biomes.BEACH);
   private static final int SNOWY_BEACH = IRegistry.field_212624_m.func_148757_b(Biomes.SNOWY_BEACH);
   ...
   private static final int JUNGLE_EDGE = IRegistry.field_212624_m.func_148757_b(Biomes.JUNGLE_EDGE);
   ...
   private static final int ERODED_BADLANDS = IRegistry.field_212624_m.func_148757_b(Biomes.ERODED_BADLANDS);
   private static final int MODIFIED_WOODED_BADLANDS_PLATEAU = IRegistry.field_212624_m.func_148757_b(Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU);
   private static final int MODIFIED_BADLANDS_PLATEAU = IRegistry.field_212624_m.func_148757_b(Biomes.MODIFIED_BADLANDS_PLATEAU);
   ...
   private static final int MOUNTAIN_EDGE = IRegistry.field_212624_m.func_148757_b(Biomes.MOUNTAIN_EDGE);
   private static final int STONE_SHORE = IRegistry.field_212624_m.func_148757_b(Biomes.STONE_SHORE);
   ...
   public int apply(IContext p_202748_1_, int p_202748_2_, int p_202748_3_, int p_202748_4_, int p_202748_5_, int p_202748_6_) {
      Biome biome = IRegistry.field_212624_m.func_148754_a(p_202748_6_);
   ...
   private static boolean isJungleCompatible(int p_151631_0_) {
      if (IRegistry.field_212624_m.func_148754_a(p_151631_0_) != null && IRegistry.field_212624_m.func_148754_a(p_151631_0_).getBiomeCategory() == Biome.Category.JUNGLE) {
         return true;
      } else {
