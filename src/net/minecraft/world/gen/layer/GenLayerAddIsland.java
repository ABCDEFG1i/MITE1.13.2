...
public enum GenLayerAddIsland implements IBishopTransformer {
   ...
   public int apply(IContext p_202792_1_, int p_202792_2_, int p_202792_3_, int p_202792_4_, int p_202792_5_, int p_202792_6_) {
      if (!LayerUtil.isShallowOcean(p_202792_6_) || LayerUtil.isShallowOcean(p_202792_5_) && LayerUtil.isShallowOcean(p_202792_4_) && LayerUtil.isShallowOcean(p_202792_2_) && LayerUtil.isShallowOcean(p_202792_3_)) {
         ...
         int i = 1;
         int j = 1;
         if (!LayerUtil.isShallowOcean(p_202792_5_) && p_202792_1_.random(i++) == 0) {
            j = p_202792_5_;
         }

         if (!LayerUtil.isShallowOcean(p_202792_4_) && p_202792_1_.random(i++) == 0) {
            j = p_202792_4_;
         }

         if (!LayerUtil.isShallowOcean(p_202792_2_) && p_202792_1_.random(i++) == 0) {
            j = p_202792_2_;
         }

         if (!LayerUtil.isShallowOcean(p_202792_3_) && p_202792_1_.random(i++) == 0) {
            j = p_202792_3_;
         }
