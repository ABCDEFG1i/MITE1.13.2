...
public enum GenLayerBiomeEdge implements ICastleTransformer {
   ...
   private boolean func_202751_a(int[] p_202751_1_, int p_202751_2_, int p_202751_3_, int p_202751_4_, int p_202751_5_, int p_202751_6_, int p_202751_7_, int p_202751_8_) {
      if (!LayerUtil.func_202826_a(p_202751_6_, p_202751_7_)) {
         return false;
      } else {
   ...
   private boolean replaceBiomeEdge(int[] p_151635_1_, int p_151635_2_, int p_151635_3_, int p_151635_4_, int p_151635_5_, int p_151635_6_, int p_151635_7_, int p_151635_8_) {
      if (p_151635_6_ != p_151635_7_) {
         ...
         if (LayerUtil.func_202826_a(p_151635_2_, p_151635_7_) && LayerUtil.func_202826_a(p_151635_3_, p_151635_7_) && LayerUtil.func_202826_a(p_151635_5_, p_151635_7_) && LayerUtil.func_202826_a(p_151635_4_, p_151635_7_)) {
   ...
   private boolean canBiomesBeNeighbors(int p_151634_1_, int p_151634_2_) {
      if (LayerUtil.func_202826_a(p_151634_1_, p_151634_2_)) {
         return true;
      } else {
         Biome biome = IRegistry.field_212624_m.func_148754_a(p_151634_1_);
         Biome biome1 = IRegistry.field_212624_m.func_148754_a(p_151634_2_);
