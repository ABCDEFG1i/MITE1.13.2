...
public class EndSpikes extends BasePlacement<NoPlacementConfig> {
   ...
   public <C extends IFeatureConfig> boolean generate(IWorld p_201491_1_, IChunkGenerator<? extends IChunkGenSettings> p_201491_2_, Random p_201491_3_, BlockPos p_201491_4_, NoPlacementConfig p_201491_5_, Feature<C> p_201491_6_, C p_201491_7_) {
      EndCrystalTowerFeature.EndSpike[] aendcrystaltowerfeature$endspike = getSpikes(p_201491_1_);
      boolean flag = false;

      for(EndCrystalTowerFeature.EndSpike endcrystaltowerfeature$endspike : aendcrystaltowerfeature$endspike) {
         if (endcrystaltowerfeature$endspike.doesStartInChunk(p_201491_4_)) {
            ((EndCrystalTowerFeature)p_201491_6_).setSpike(endcrystaltowerfeature$endspike);
            flag |= ((EndCrystalTowerFeature)p_201491_6_).func_212245_a(p_201491_1_, p_201491_2_, p_201491_3_, new BlockPos(endcrystaltowerfeature$endspike.getCenterX(), 45, endcrystaltowerfeature$endspike.getCenterZ()), IFeatureConfig.NO_FEATURE_CONFIG);
         }
      }
   ...
   public static EndCrystalTowerFeature.EndSpike[] getSpikes(IWorld p_202466_0_) {
      Random random = new Random(p_202466_0_.getSeed());
