...
public class TwiceSurfaceWithChance extends BasePlacement<ChanceConfig> {
   public <C extends IFeatureConfig> boolean generate(IWorld p_201491_1_, IChunkGenerator<? extends IChunkGenSettings> p_201491_2_, Random p_201491_3_, BlockPos p_201491_4_, ChanceConfig p_201491_5_, Feature<C> p_201491_6_, C p_201491_7_) {
      if (p_201491_3_.nextFloat() < 1.0F / (float)p_201491_5_.chance) {
         ...
         int k = p_201491_1_.getHeight(Heightmap.Type.MOTION_BLOCKING, p_201491_4_.add(i, 0, j)).getY() * 2;
         if (k <= 0) {
            return false;
         }

         int l = p_201491_3_.nextInt(k);
         p_201491_6_.func_212245_a(p_201491_1_, p_201491_2_, p_201491_3_, p_201491_4_.add(i, l, j), p_201491_7_);
      }
