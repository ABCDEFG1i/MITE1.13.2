...
public class HeightVeryBiasedRange extends BasePlacement<CountRangeConfig> {
   public <C extends IFeatureConfig> boolean generate(IWorld p_201491_1_, IChunkGenerator<? extends IChunkGenSettings> p_201491_2_, Random p_201491_3_, BlockPos p_201491_4_, CountRangeConfig p_201491_5_, Feature<C> p_201491_6_, C p_201491_7_) {
      for(int i = 0; i < p_201491_5_.count; ++i) {
         ...
         int l = p_201491_3_.nextInt(p_201491_3_.nextInt(p_201491_3_.nextInt(p_201491_5_.maxHeight - p_201491_5_.maxHeightBase) + p_201491_5_.minHeight) + p_201491_5_.minHeight);
         BlockPos blockpos = p_201491_4_.add(j, l, k);
