...
public class BonusChestFeature extends Feature<NoFeatureConfig> {
   public boolean func_212245_a(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
      for(IBlockState iblockstate = p_212245_1_.getBlockState(p_212245_4_); (iblockstate.isAir() || iblockstate.isIn(BlockTags.LEAVES)) && p_212245_4_.getY() > 1; iblockstate = p_212245_1_.getBlockState(p_212245_4_)) {
      ...
      if (p_212245_4_.getY() < 1) {
         ...
         for(int i = 0; i < 4; ++i) {
            ...
            if (p_212245_1_.isAirBlock(blockpos) && p_212245_1_.getBlockState(blockpos.down()).isTopSolid()) {
               ...
               if (p_212245_1_.isAirBlock(blockpos2) && p_212245_1_.getBlockState(blockpos2.down()).isTopSolid()) {
                  p_212245_1_.setBlockState(blockpos2, Blocks.TORCH.getDefaultState(), 2);
               }

               if (p_212245_1_.isAirBlock(blockpos1) && p_212245_1_.getBlockState(blockpos1.down()).isTopSolid()) {
                  p_212245_1_.setBlockState(blockpos1, Blocks.TORCH.getDefaultState(), 2);
               }

               if (p_212245_1_.isAirBlock(blockpos3) && p_212245_1_.getBlockState(blockpos3.down()).isTopSolid()) {
                  p_212245_1_.setBlockState(blockpos3, Blocks.TORCH.getDefaultState(), 2);
               }

               if (p_212245_1_.isAirBlock(blockpos4) && p_212245_1_.getBlockState(blockpos4.down()).isTopSolid()) {
