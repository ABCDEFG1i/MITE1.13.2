...
public class CompositeFeature<F extends IFeatureConfig, D extends IPlacementConfig> extends Feature<NoFeatureConfig> {
   ...
   public CompositeFeature(Feature<F> p_i48688_1_, F p_i48688_2_, BasePlacement<D> p_i48688_3_, D p_i48688_4_) {
      this.featureConfig = p_i48688_2_;
      this.placementConfig = p_i48688_4_;
      this.basePlacement = p_i48688_3_;
      this.feature = p_i48688_1_;
   }
