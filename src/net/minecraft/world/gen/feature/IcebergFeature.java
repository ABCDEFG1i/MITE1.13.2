...
public class IcebergFeature extends Feature<IcebergConfig> {
      ...
      for(int k = -i; k < i; ++k) {
         for(int l = -i; l < i; ++l) {
            ...
            if (d0 < 0.0D) {
               ...
               if (this.func_205179_a(block) || block == Blocks.SNOW_BLOCK) {
                  if (p_205174_5_) {
                     ...
                     this.func_205185_a(p_205174_4_, blockpos);
                  }
               }
            }
         }
   ...
   private void func_205185_a(IWorld p_205185_1_, BlockPos p_205185_2_) {
   ...
   private boolean func_205179_a(Block p_205179_1_) {
      ...
      for(int j = -i; j <= i; ++j) {
         for(int k = -i; k <= i; ++k) {
            for(int l = 0; l <= p_205186_4_; ++l) {
               ...
               if (this.func_205179_a(block) || block == Blocks.SNOW) {
                  ...
                  } else if (this.func_205179_a(block)) {
