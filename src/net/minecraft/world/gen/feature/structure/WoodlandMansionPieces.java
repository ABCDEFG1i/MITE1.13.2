...
public class WoodlandMansionPieces {
   public static void registerWoodlandMansionPieces() {
      StructureIO.registerStructureComponent(WoodlandMansionPieces.MansionTemplate.class, "WMP");
   }
   ...
   static class Grid {
      ...
      private void recursiveCorridor(WoodlandMansionPieces.SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, EnumFacing p_191110_4_, int p_191110_5_) {
         if (p_191110_5_ > 0) {
            ...
            p_191110_1_.func_197588_a(p_191110_2_ + p_191110_4_.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset(), 0, 1);
            ...
            p_191110_1_.func_197588_a(p_191110_2_ + enumfacing1.getXOffset(), p_191110_3_ + enumfacing1.getZOffset(), 0, 2);
            p_191110_1_.func_197588_a(p_191110_2_ + enumfacing2.getXOffset(), p_191110_3_ + enumfacing2.getZOffset(), 0, 2);
            p_191110_1_.func_197588_a(p_191110_2_ + p_191110_4_.getXOffset() + enumfacing1.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset() + enumfacing1.getZOffset(), 0, 2);
            p_191110_1_.func_197588_a(p_191110_2_ + p_191110_4_.getXOffset() + enumfacing2.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset() + enumfacing2.getZOffset(), 0, 2);
            p_191110_1_.func_197588_a(p_191110_2_ + p_191110_4_.getXOffset() * 2, p_191110_3_ + p_191110_4_.getZOffset() * 2, 0, 2);
            p_191110_1_.func_197588_a(p_191110_2_ + enumfacing1.getXOffset() * 2, p_191110_3_ + enumfacing1.getZOffset() * 2, 0, 2);
            p_191110_1_.func_197588_a(p_191110_2_ + enumfacing2.getXOffset() * 2, p_191110_3_ + enumfacing2.getZOffset() * 2, 0, 2);
         }
      }
      ...
      private void setupThirdFloor() {
         ...
         if (list.isEmpty()) {
            ...
            EnumFacing enumfacing1 = this.get1x2RoomDirection(this.baseGrid, tuple.getA(), tuple.getB(), 1, l1 & '\uffff');
            int i2 = tuple.getA() + enumfacing1.getXOffset();
            int i1 = tuple.getB() + enumfacing1.getZOffset();
   ...
   public static class MansionTemplate extends TemplateStructurePiece {
      ...
      protected void writeStructureToNBT(NBTTagCompound p_143012_1_) {
         ...
         p_143012_1_.setString("Template", this.templateName);
         p_143012_1_.setString("Rot", this.placeSettings.getRotation().name());
         p_143012_1_.setString("Mi", this.placeSettings.getMirror().name());
      }
      ...
      protected void readStructureFromNBT(NBTTagCompound p_143011_1_, TemplateManager p_143011_2_) {
         ...
         this.templateName = p_143011_1_.getString("Template");
         this.rotation = Rotation.valueOf(p_143011_1_.getString("Rot"));
         this.mirror = Mirror.valueOf(p_143011_1_.getString("Mi"));
      ...
      protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, IWorld p_186175_3_, Random p_186175_4_, MutableBoundingBox p_186175_5_) {
         if (p_186175_1_.startsWith("Chest")) {
            ...
            if ("ChestWest".equals(p_186175_1_)) {
               iblockstate = iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.WEST));
            } else if ("ChestEast".equals(p_186175_1_)) {
               iblockstate = iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.EAST));
            } else if ("ChestSouth".equals(p_186175_1_)) {
               iblockstate = iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.SOUTH));
            } else if ("ChestNorth".equals(p_186175_1_)) {
               iblockstate = iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.NORTH));
            }
            ...
            EntityEvoker entityevoker = new EntityEvoker(p_186175_3_.getWorld());
            ...
            for(int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.height; ++k1) {
               for(int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1) {
                  ...
                  if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1) {
                     ...
                     BlockPos blockpos3 = blockpos.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k1 - this.startY) * 8);
                     blockpos3 = blockpos3.offset(p_191125_2_.rotate(EnumFacing.EAST), -1 + (l1 - this.startX) * 8);
                     if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1 - 1, k1) && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1 - 1, k1, l2, k2)) {
                        p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.WEST ? s3 : s2, blockpos3, p_191125_2_));
                     }

                     if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1) {
                        BlockPos blockpos2 = blockpos3.offset(p_191125_2_.rotate(EnumFacing.EAST), 8);
                        p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.EAST ? s3 : s2, blockpos2, p_191125_2_));
                     }
                     ...
                     if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2)) {
                        BlockPos blockpos4 = blockpos3.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 7);
                     ...
                     if (woodlandmansionpieces$simplegrid3.get(l1, k1 - 1) == 1 && !flag1) {
                        BlockPos blockpos5 = blockpos3.offset(p_191125_2_.rotate(EnumFacing.NORTH), 1);
                     ...
                     if (j2 == 65536) {
                        this.addRoom1x1(p_191125_3_, blockpos3, p_191125_2_, enumfacing1, awoodlandmansionpieces$roomcollection[l2]);
                        ...
                        this.addRoom1x2(p_191125_3_, blockpos3, p_191125_2_, enumfacing3, enumfacing1, awoodlandmansionpieces$roomcollection[l2], flag2);
                        ...
                        this.addRoom2x2(p_191125_3_, blockpos3, p_191125_2_, enumfacing2, enumfacing1, awoodlandmansionpieces$roomcollection[l2]);
   ...
   static class SimpleGrid {
      ...
      public void func_197588_a(int p_197588_1_, int p_197588_2_, int p_197588_3_, int p_197588_4_) {
