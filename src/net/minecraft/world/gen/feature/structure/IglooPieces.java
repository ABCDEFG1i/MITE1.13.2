...
public class IglooPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      protected void writeStructureToNBT(NBTTagCompound p_143012_1_) {
         ...
         p_143012_1_.setString("Template", this.field_207615_d.toString());
         p_143012_1_.setString("Rot", this.field_207616_e.name());
      }
      ...
      protected void readStructureFromNBT(NBTTagCompound p_143011_1_, TemplateManager p_143011_2_) {
         ...
         this.field_207615_d = new ResourceLocation(p_143011_1_.getString("Template"));
         this.field_207616_e = Rotation.valueOf(p_143011_1_.getString("Rot"));
      ...
      protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, IWorld p_186175_3_, Random p_186175_4_, MutableBoundingBox p_186175_5_) {
         if ("chest".equals(p_186175_1_)) {
            ...
            TileEntity tileentity = p_186175_3_.getTileEntity(p_186175_2_.down());
            if (tileentity instanceof TileEntityChest) {
               ((TileEntityChest)tileentity).setLootTable(LootTableList.CHESTS_IGLOO_CHEST, p_186175_4_.nextLong());
            }
      ...
      public boolean addComponentParts(IWorld p_74875_1_, Random p_74875_2_, MutableBoundingBox p_74875_3_, ChunkPos p_74875_4_) {
         ...
         int i = p_74875_1_.getHeight(Heightmap.Type.WORLD_SURFACE_WG, blockpos1.getX(), blockpos1.getZ());
         BlockPos blockpos2 = this.templatePosition;
         this.templatePosition = this.templatePosition.add(0, i - 90 - 1, 0);
         boolean flag = super.addComponentParts(p_74875_1_, p_74875_2_, p_74875_3_, p_74875_4_);
         if (this.field_207615_d.equals(IglooPieces.field_202592_e)) {
            ...
            IBlockState iblockstate = p_74875_1_.getBlockState(blockpos3.down());
            if (!iblockstate.isAir() && iblockstate.getBlock() != Blocks.LADDER) {
               p_74875_1_.setBlockState(blockpos3, Blocks.SNOW_BLOCK.getDefaultState(), 3);
            }
         }
