...
public class OceanRuinPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      protected void writeStructureToNBT(NBTTagCompound p_143012_1_) {
         ...
         p_143012_1_.setString("Template", this.field_204038_f.toString());
         p_143012_1_.setString("Rot", this.field_204039_g.name());
         p_143012_1_.setFloat("Integrity", this.field_204037_e);
         p_143012_1_.setString("BiomeType", this.field_204036_d.toString());
         p_143012_1_.setBoolean("IsLarge", this.field_204040_h);
      }
      ...
      protected void readStructureFromNBT(NBTTagCompound p_143011_1_, TemplateManager p_143011_2_) {
         ...
         this.field_204038_f = new ResourceLocation(p_143011_1_.getString("Template"));
         this.field_204039_g = Rotation.valueOf(p_143011_1_.getString("Rot"));
         this.field_204037_e = p_143011_1_.getFloat("Integrity");
         this.field_204036_d = OceanRuinStructure.Type.valueOf(p_143011_1_.getString("BiomeType"));
         this.field_204040_h = p_143011_1_.getBoolean("IsLarge");
      ...
      protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, IWorld p_186175_3_, Random p_186175_4_, MutableBoundingBox p_186175_5_) {
         if ("chest".equals(p_186175_1_)) {
            p_186175_3_.setBlockState(p_186175_2_, Blocks.CHEST.getDefaultState().with(BlockChest.WATERLOGGED, Boolean.valueOf(p_186175_3_.getFluidState(p_186175_2_).isTagged(FluidTags.WATER))), 2);
            TileEntity tileentity = p_186175_3_.getTileEntity(p_186175_2_);
            if (tileentity instanceof TileEntityChest) {
               ((TileEntityChest)tileentity).setLootTable(this.field_204040_h ? LootTableList.CHESTS_UNDERWATER_RUIN_BIG : LootTableList.CHESTS_UNDERWATER_RUIN_SMALL, p_186175_4_.nextLong());
            }
      ...
      public boolean addComponentParts(IWorld p_74875_1_, Random p_74875_2_, MutableBoundingBox p_74875_3_, ChunkPos p_74875_4_) {
         ...
         int i = p_74875_1_.getHeight(Heightmap.Type.OCEAN_FLOOR_WG, this.templatePosition.getX(), this.templatePosition.getZ());
         ...
         this.templatePosition = new BlockPos(this.templatePosition.getX(), this.func_204035_a(this.templatePosition, p_74875_1_, blockpos), this.templatePosition.getZ());
