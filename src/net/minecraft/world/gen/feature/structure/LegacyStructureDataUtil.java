...
public abstract class LegacyStructureDataUtil {
   ...
   public NBTTagCompound func_212181_a(NBTTagCompound p_212181_1_) {
      NBTTagCompound nbttagcompound = p_212181_1_.getCompoundTag("Level");
      ChunkPos chunkpos = new ChunkPos(nbttagcompound.getInteger("xPos"), nbttagcompound.getInteger("zPos"));
      if (this.func_208209_a(chunkpos.x, chunkpos.z)) {
         p_212181_1_ = this.func_212182_a(p_212181_1_, chunkpos);
      }

      NBTTagCompound nbttagcompound1 = nbttagcompound.getCompoundTag("Structures");
      NBTTagCompound nbttagcompound2 = nbttagcompound1.getCompoundTag("References");

      for(String s : this.func_208218_b()) {
         Structure<?> structure = Feature.STRUCTURES.get(s.toLowerCase(Locale.ROOT));
         if (!nbttagcompound2.hasKey(s, 12) && structure != null) {
   ...
   private NBTTagCompound func_212182_a(NBTTagCompound p_212182_1_, ChunkPos p_212182_2_) {
      NBTTagCompound nbttagcompound = p_212182_1_.getCompoundTag("Level");
      NBTTagCompound nbttagcompound1 = nbttagcompound.getCompoundTag("Structures");
      NBTTagCompound nbttagcompound2 = nbttagcompound1.getCompoundTag("Starts");
   ...
   private void func_212184_a(@Nullable WorldSavedDataStorage p_212184_1_) {
      if (p_212184_1_ != null) {
         for(String s : this.func_208214_a()) {
            ...
            try {
               nbttagcompound = p_212184_1_.func_208028_a(s, 1493).getCompoundTag("data").getCompoundTag("Features");
            ...
            for(String s1 : nbttagcompound.getKeySet()) {
               NBTTagCompound nbttagcompound1 = nbttagcompound.getCompoundTag(s1);
               long i = ChunkPos.asLong(nbttagcompound1.getInteger("ChunkX"), nbttagcompound1.getInteger("ChunkZ"));
               NBTTagList nbttaglist = nbttagcompound1.getTagList("Children", 10);
               if (!nbttaglist.isEmpty()) {
                  String s3 = nbttaglist.getCompoundTagAt(0).getString("id");
            ...
            if (structureindexessaveddata != null && !structureindexessaveddata.getAll().isEmpty()) {
               ...
               for(String s2 : nbttagcompound.getKeySet()) {
                  NBTTagCompound nbttagcompound2 = nbttagcompound.getCompoundTag(s2);
                  structureindexessaveddata1.func_201763_a(ChunkPos.asLong(nbttagcompound2.getInteger("ChunkX"), nbttagcompound2.getInteger("ChunkZ")));
               }
