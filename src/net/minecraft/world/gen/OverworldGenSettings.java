...
public class OverworldGenSettings extends ChunkGenSettings {
   ...
   public double func_202193_n() {
      return 200.0D;
   }

   public double func_202194_o() {
      return 200.0D;
   }

   public double func_202189_p() {
      return 0.5D;
   }

   public float func_202195_q() {
      return 684.412F;
   }

   public float func_202196_r() {
      return 684.412F;
   }

   public float func_202192_s() {
      return 80.0F;
   }

   public float func_202190_t() {
      return 160.0F;
   }

   public float func_202191_u() {
      return 80.0F;
   }
   ...
   public double func_202207_B() {
      return 512.0D;
   }

   public double func_202208_C() {
      return 512.0D;
   }
}
