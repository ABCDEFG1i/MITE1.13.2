...
public class FlatGenSettings extends ChunkGenSettings {
   ...
   public static Block func_212683_a(String p_212683_0_) {
      try {
         ...
         if (IRegistry.field_212618_g.func_212607_c(resourcelocation)) {
            return IRegistry.field_212618_g.func_82594_a(resourcelocation);
         }
      ...
      for(FlatLayerInfo flatlayerinfo1 : this.flatLayers) {
         for(int j = flatlayerinfo1.getMinY(); j < flatlayerinfo1.getMinY() + flatlayerinfo1.getLayerCount(); ++j) {
            ...
            if (iblockstate.getBlock() != Blocks.AIR) {
               ...
               this.field_202244_C[j] = iblockstate;
            }
         }
   ...
   public <T> Dynamic<T> func_210834_a(DynamicOps<T> p_210834_1_) {
      T t = p_210834_1_.createList(this.flatLayers.stream().map((p_210837_1_) -> {
         return p_210834_1_.createMap(ImmutableMap.of(p_210834_1_.createString("height"), p_210834_1_.createInt(p_210837_1_.getLayerCount()), p_210834_1_.createString("block"), p_210834_1_.createString(IRegistry.field_212618_g.func_177774_c(p_210837_1_.getLayerMaterial().getBlock()).toString())));
      }));
      ...
      return new Dynamic<>(p_210834_1_, p_210834_1_.createMap(ImmutableMap.of(p_210834_1_.createString("layers"), t, p_210834_1_.createString("biome"), p_210834_1_.createString(IRegistry.field_212624_m.func_177774_c(this.biomeToUse).toString()), p_210834_1_.createString("structures"), t1)));
   }
   ...
   public static FlatGenSettings func_210835_a(Dynamic<?> p_210835_0_) {
      ...
      List<Pair<Integer, Block>> list = p_210835_0_.get("layers").flatMap(Dynamic::getStream).orElse(Stream.empty()).map((p_210838_0_) -> {
      ...
      if (list.stream().anyMatch((p_211743_0_) -> {
         ...
         if (list1.isEmpty()) {
            ...
            flatgensettings.setBiome(IRegistry.field_212624_m.func_212608_b(new ResourceLocation(p_210835_0_.getString("biome"))));
   ...
   @OnlyIn(Dist.CLIENT)
   public static FlatGenSettings createFlatGeneratorFromString(String p_82651_0_) {
