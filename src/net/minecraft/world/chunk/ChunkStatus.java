...
public enum ChunkStatus implements ITaskType<ChunkPos, ChunkStatus> {
   ...
   DECORATED("decorated", new DecorateChunkTask(), 1, true, ChunkStatus.Type.PROTOCHUNK) {
      public void acceptInRange(ChunkPos p_201492_1_, BiConsumer<ChunkPos, ChunkStatus> p_201492_2_) {
         int i = p_201492_1_.x;
         int j = p_201492_1_.z;
            ...
            if (l < i - 1 || l > i + 1) {
               for(int i1 = j - 8; i1 <= j + 8; ++i1) {
                  if (i1 < j - 1 || i1 > j + 1) {
                     ...
                     p_201492_2_.accept(chunkpos, EMPTY);
                  }
               }
            }
         }
         ...
         for(int j1 = i - 1; j1 <= i + 1; ++j1) {
            for(int k1 = j - 1; k1 <= j + 1; ++k1) {
               ...
               p_201492_2_.accept(chunkpos1, chunkstatus);
            }
         }
   ...
   public ChunkPrimer runTask(World p_202126_1_, IChunkGenerator<?> p_202126_2_, Map<ChunkPos, ChunkPrimer> p_202126_3_, int p_202126_4_, int p_202126_5_) {
      return this.task.run(this, p_202126_1_, p_202126_2_, p_202126_3_, p_202126_4_, p_202126_5_);
   }
   ...
   public void acceptInRange(ChunkPos p_201492_1_, BiConsumer<ChunkPos, ChunkStatus> p_201492_2_) {
      ...
      for(int k = i - this.taskRange; k <= i + this.taskRange; ++k) {
         for(int l = j - this.taskRange; l <= j + this.taskRange; ++l) {
            p_201492_2_.accept(new ChunkPos(k, l), chunkstatus);
         }
      }
   ...
   @Nullable
   public static ChunkStatus getByName(String p_202127_0_) {
      return NAME_TO_STATUS.get(p_202127_0_);
   }
   ...
   public boolean comesAfter(ChunkStatus p_209003_1_) {
