...
public class PaintingType {
   ...
   public PaintingType(int p_i48560_1_, int p_i48560_2_, int p_i48560_3_, int p_i48560_4_) {
      this.width = p_i48560_1_;
      this.height = p_i48560_2_;
      this.u = p_i48560_3_;
      this.v = p_i48560_4_;
   }
   ...
   public static PaintingType register(String p_200836_0_, int p_200836_1_, int p_200836_2_, int p_200836_3_, int p_200836_4_) {
      PaintingType paintingtype = new PaintingType(p_200836_1_, p_200836_2_, p_200836_3_, p_200836_4_);
      IRegistry.field_212620_i.func_82595_a(new ResourceLocation(p_200836_0_), paintingtype);
      return paintingtype;
   }
}
