...
public abstract class AbstractSkeleton extends EntityMob implements IRangedAttackMob {
   ...
   protected AbstractSkeleton(EntityType<?> p_i48555_1_, World p_i48555_2_) {
   ...
   public IEntityLivingData onInitialSpawn(DifficultyInstance p_204210_1_, @Nullable IEntityLivingData p_204210_2_, @Nullable NBTTagCompound p_204210_3_) {
      ...
      this.setCombatTask();
      this.setCanPickUpLoot(this.rand.nextFloat() < 0.55F * p_204210_1_.getClampedAdditionalDifficulty());
   ...
   public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
      EntityArrow entityarrow = this.getArrow(p_82196_2_);
   ...
   public void setItemStackToSlot(EntityEquipmentSlot p_184201_1_, ItemStack p_184201_2_) {
      ...
      if (!this.world.isRemote && p_184201_1_ == EntityEquipmentSlot.MAINHAND) {
         this.setCombatTask();
      }
   ...
   public void setSwingingArms(boolean p_184724_1_) {
      this.dataManager.set(SWINGING_ARMS, p_184724_1_);
   }
}
