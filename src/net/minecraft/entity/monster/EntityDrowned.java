...
public class EntityDrowned extends EntityZombie implements IRangedAttackMob {
   ...
   protected PathNavigate createNavigator(World p_175447_1_) {
      return super.createNavigator(p_175447_1_);
   }
   ...
   public boolean func_205020_a(IWorld p_205020_1_, boolean p_205020_2_) {
      Biome biome = p_205020_1_.getBiome(new BlockPos(this.posX, this.posY, this.posZ));
      if (biome != Biomes.RIVER && biome != Biomes.FROZEN_RIVER) {
         return this.rand.nextInt(40) == 0 && this.func_204712_dC() && super.func_205020_a(p_205020_1_, p_205020_2_);
      } else {
         return this.rand.nextInt(15) == 0 && super.func_205020_a(p_205020_1_, p_205020_2_);
      }
   }
   ...
   public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
      ...
      double d1 = p_82196_1_.getEntityBoundingBox().minY + (double)(p_82196_1_.height / 3.0F) - entitytrident.posY;
   ...
   static class AIGoToWater extends EntityAIBase {
      ...
      private Vec3d func_204729_f() {
         ...
         BlockPos blockpos = new BlockPos(this.field_204730_a.posX, this.field_204730_a.getEntityBoundingBox().minY, this.field_204730_a.posZ);
   ...
   static class MoveHelper extends EntityMoveHelper {
      ...
      public void tick() {
         ...
         if (this.drowned.func_204715_dF() && this.drowned.isInWater()) {
            ...
            float f1 = (float)(this.speed * this.drowned.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue());
