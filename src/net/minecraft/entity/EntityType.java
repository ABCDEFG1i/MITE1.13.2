...
public class EntityType<T extends Entity> {
   ...
   public static <T extends Entity> EntityType<T> register(String p_200712_0_, EntityType.Builder<T> p_200712_1_) {
      EntityType<T> entitytype = p_200712_1_.build(p_200712_0_);
      IRegistry.field_212629_r.func_82595_a(new ResourceLocation(p_200712_0_), entitytype);
      return entitytype;
   }

   @Nullable
   public static ResourceLocation getId(EntityType<?> p_200718_0_) {
      return IRegistry.field_212629_r.func_177774_c(p_200718_0_);
   }

   @Nullable
   public static EntityType<?> getById(String p_200713_0_) {
      return IRegistry.field_212629_r.func_212608_b(ResourceLocation.makeResourceLocation(p_200713_0_));
   }
   ...
   public EntityType(Class<? extends T> p_i49579_1_, Function<? super World, ? extends T> p_i49579_2_, boolean p_i49579_3_, boolean p_i49579_4_, @Nullable Type<?> p_i49579_5_) {
      this.entityClass = p_i49579_1_;
      this.factory = p_i49579_2_;
   ...
   @Nullable
   public Entity spawnEntity(World p_208049_1_, @Nullable ItemStack p_208049_2_, @Nullable EntityPlayer p_208049_3_, BlockPos p_208049_4_, boolean p_208049_5_, boolean p_208049_6_) {
      return this.spawnEntity(p_208049_1_, p_208049_2_ == null ? null : p_208049_2_.getTag(), p_208049_2_ != null && p_208049_2_.hasDisplayName() ? p_208049_2_.getDisplayName() : null, p_208049_3_, p_208049_4_, p_208049_5_, p_208049_6_);
   }

   @Nullable
   public T spawnEntity(World p_208050_1_, @Nullable NBTTagCompound p_208050_2_, @Nullable ITextComponent p_208050_3_, @Nullable EntityPlayer p_208050_4_, BlockPos p_208050_5_, boolean p_208050_6_, boolean p_208050_7_) {
      T t = this.makeEntity(p_208050_1_, p_208050_2_, p_208050_3_, p_208050_4_, p_208050_5_, p_208050_6_, p_208050_7_);
      p_208050_1_.spawnEntity(t);
      return t;
   }
   ...
   public T makeEntity(World p_210761_1_, @Nullable NBTTagCompound p_210761_2_, @Nullable ITextComponent p_210761_3_, @Nullable EntityPlayer p_210761_4_, BlockPos p_210761_5_, boolean p_210761_6_, boolean p_210761_7_) {
      ...
      if (t == null) {
         ...
         double d0;
         if (p_210761_6_) {
            t.setPosition((double)p_210761_5_.getX() + 0.5D, (double)(p_210761_5_.getY() + 1), (double)p_210761_5_.getZ() + 0.5D);
            d0 = func_208051_a(p_210761_1_, p_210761_5_, p_210761_7_, t.getEntityBoundingBox());
         } else {
            d0 = 0.0D;
         }

         t.setLocationAndAngles((double)p_210761_5_.getX() + 0.5D, (double)p_210761_5_.getY() + d0, (double)p_210761_5_.getZ() + 0.5D, MathHelper.wrapDegrees(p_210761_1_.rand.nextFloat() * 360.0F), 0.0F);
         ...
         if (p_210761_3_ != null && t instanceof EntityLivingBase) {
            t.setCustomName(p_210761_3_);
         }

         func_208048_a(p_210761_1_, p_210761_4_, t, p_210761_2_);
         return t;
      }
   }
   ...
   public static void func_208048_a(World p_208048_0_, @Nullable EntityPlayer p_208048_1_, @Nullable Entity p_208048_2_, @Nullable NBTTagCompound p_208048_3_) {
      if (p_208048_3_ != null && p_208048_3_.hasKey("EntityTag", 10)) {
         ...
         if (minecraftserver != null && p_208048_2_ != null) {
            if (p_208048_0_.isRemote || !p_208048_2_.ignoreItemEntityData() || p_208048_1_ != null && minecraftserver.getPlayerList().canSendCommands(p_208048_1_.getGameProfile())) {
               NBTTagCompound nbttagcompound = p_208048_2_.writeToNBT(new NBTTagCompound());
               UUID uuid = p_208048_2_.getUniqueID();
               nbttagcompound.merge(p_208048_3_.getCompoundTag("EntityTag"));
               p_208048_2_.setUniqueId(uuid);
               p_208048_2_.readFromNBT(nbttagcompound);
            }
         }
      }
   }
   ...
   public String getTranslationKey() {
      if (this.translationKey == null) {
         this.translationKey = Util.makeTranslationKey("entity", IRegistry.field_212629_r.func_177774_c(this));
      }
   ...
   @Nullable
   public static Entity create(World p_200714_0_, ResourceLocation p_200714_1_) {
      return create(p_200714_0_, IRegistry.field_212629_r.func_212608_b(p_200714_1_));
   }

   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static Entity create(int p_200717_0_, World p_200717_1_) {
      return create(p_200717_1_, IRegistry.field_212629_r.func_148754_a(p_200717_0_));
   }
   ...
   public static class Builder<T extends Entity> {
      ...
      private Builder(Class<? extends T> p_i48756_1_, Function<? super World, ? extends T> p_i48756_2_) {
         this.entityClass = p_i48756_1_;
         this.factory = p_i48756_2_;
      }

      public static <T extends Entity> EntityType.Builder<T> create(Class<? extends T> p_201757_0_, Function<? super World, ? extends T> p_201757_1_) {
         return new EntityType.Builder<>(p_201757_0_, p_201757_1_);
      }
      ...
      public EntityType<T> build(String p_206830_1_) {
         ...
         if (this.serializable) {
            try {
               type = DataFixesManager.getDataFixer().getSchema(DataFixUtils.makeKey(1631)).getChoiceType(TypeReferences.ENTITY_TYPE, p_206830_1_);
