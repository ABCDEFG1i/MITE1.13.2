...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
   ...
   public void useRecipe(MerchantRecipe p_70933_1_) {
      ...
      if (this.buyingPlayer instanceof EntityPlayerMP) {
         CriteriaTriggers.VILLAGER_TRADE.trigger((EntityPlayerMP)this.buyingPlayer, this, p_70933_1_.getItemToSell());
      }
   ...
   public void verifySellingItem(ItemStack p_110297_1_) {
      if (!this.world.isRemote && this.livingSoundTime > -this.getTalkInterval() + 20) {
         this.livingSoundTime = -this.getTalkInterval();
         this.playSound(p_110297_1_.isEmpty() ? SoundEvents.ENTITY_VILLAGER_NO : SoundEvents.ENTITY_VILLAGER_YES, this.getSoundVolume(), this.getSoundPitch());
      }
   ...
   public static class EmeraldForItems implements EntityVillager.ITradeList {
      ...
      public void addMerchantRecipe(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
         ItemStack itemstack = new ItemStack(this.buyingItem, this.price == null ? 1 : this.price.getPrice(p_190888_3_));
   ...
   public static class ItemAndEmeraldToItem implements EntityVillager.ITradeList {
      ...
      public void addMerchantRecipe(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
         ...
         p_190888_2_.add(new MerchantRecipe(new ItemStack(this.field_199763_a.getItem(), i), new ItemStack(Items.EMERALD), new ItemStack(this.field_199764_c.getItem(), j)));
      }
   }
   ...
   public static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList {
      ...
      public void addMerchantRecipe(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
         ...
         ItemStack itemstack1 = EnchantmentHelper.addRandomEnchantment(p_190888_3_, new ItemStack(this.enchantedItemStack.getItem()), 5 + p_190888_3_.nextInt(15), false);
   ...
   public static class PriceInfo extends Tuple<Integer, Integer> {
      ...
      public int getPrice(Random p_179412_1_) {
         return this.getA() >= this.getB() ? this.getA() : this.getA() + p_179412_1_.nextInt(this.getB() - this.getA() + 1);
      }
   }
