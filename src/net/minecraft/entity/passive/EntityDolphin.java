...
public class EntityDolphin extends EntityWaterMob {
   ...
   public void writeEntityToNBT(NBTTagCompound p_70014_1_) {
      ...
      p_70014_1_.setInteger("TreasurePosX", this.getTreasurePos().getX());
      p_70014_1_.setInteger("TreasurePosY", this.getTreasurePos().getY());
      p_70014_1_.setInteger("TreasurePosZ", this.getTreasurePos().getZ());
      p_70014_1_.setBoolean("GotFish", this.hasGotFish());
      p_70014_1_.setInteger("Moistness", this.getMoistness());
   }

   public void readEntityFromNBT(NBTTagCompound p_70037_1_) {
      int i = p_70037_1_.getInteger("TreasurePosX");
      int j = p_70037_1_.getInteger("TreasurePosY");
      int k = p_70037_1_.getInteger("TreasurePosZ");
      this.setTreasurePos(new BlockPos(i, j, k));
      super.readEntityFromNBT(p_70037_1_);
      this.setGotFish(p_70037_1_.getBoolean("GotFish"));
      this.setMoistness(p_70037_1_.getInteger("Moistness"));
   }
   ...
   public boolean func_205020_a(IWorld p_205020_1_, boolean p_205020_2_) {
      return this.posY > 45.0D && this.posY < (double)p_205020_1_.getSeaLevel() && p_205020_1_.getBiome(new BlockPos(this)) != Biomes.OCEAN || p_205020_1_.getBiome(new BlockPos(this)) != Biomes.DEEP_OCEAN && super.func_205020_a(p_205020_1_, p_205020_2_);
   }
   ...
   public void travel(float p_191986_1_, float p_191986_2_, float p_191986_3_) {
      if (this.isServerWorld() && this.isInWater()) {
         this.moveRelative(p_191986_1_, p_191986_2_, p_191986_3_, this.getAIMoveSpeed());
   ...
   static class AISwimToTreasure extends EntityAIBase {
      ...
      public void startExecuting() {
         ...
         BlockPos blockpos1 = world.func_211157_a(s, blockpos, 50, false);
         if (blockpos1 == null) {
            BlockPos blockpos2 = world.func_211157_a(s.equals("Ocean_Ruin") ? "Shipwreck" : "Ocean_Ruin", blockpos, 50, false);
            if (blockpos2 == null) {
      ...
      public void tick() {
         ...
         if (this.action == EntityMoveHelper.Action.MOVE_TO && !this.dolphin.getNavigator().noPath()) {
            ...
            if (d3 < (double)2.5000003E-7F) {
               ...
               float f1 = (float)(this.speed * this.dolphin.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue());
               if (this.dolphin.isInWater()) {
