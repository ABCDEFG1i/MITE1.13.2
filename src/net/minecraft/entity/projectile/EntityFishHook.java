...
public class EntityFishHook extends Entity {
         ...
         if (this.caughtEntity != null) {
            ...
            for(ItemStack itemstack : list) {
               ...
               if (itemstack.getItem().isIn(ItemTags.FISHES)) {
                  this.angler.func_195067_a(StatList.FISH_CAUGHT, 1);
               }
            }
   ...
   public void handleStatusUpdate(byte p_70103_1_) {
      if (p_70103_1_ == 31 && this.world.isRemote && this.caughtEntity instanceof EntityPlayer && ((EntityPlayer)this.caughtEntity).isUser()) {
         this.bringInHookedEntity();
      }
