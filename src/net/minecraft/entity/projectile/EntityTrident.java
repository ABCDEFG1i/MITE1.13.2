...
public class EntityTrident extends EntityArrow {
   ...
   protected Entity findEntityOnPath(Vec3d p_184551_1_, Vec3d p_184551_2_) {
      return this.dealtDamage ? null : super.findEntityOnPath(p_184551_1_, p_184551_2_);
   }
   ...
   public void onCollideWithPlayer(EntityPlayer p_70100_1_) {
      Entity entity = this.func_212360_k();
      if (entity == null || entity.getUniqueID() == p_70100_1_.getUniqueID()) {
   ...
   public void readEntityFromNBT(NBTTagCompound p_70037_1_) {
      ...
      if (p_70037_1_.hasKey("Trident", 10)) {
         this.thrownStack = ItemStack.loadFromNBT(p_70037_1_.getCompoundTag("Trident"));
      }
   ...
   public void writeEntityToNBT(NBTTagCompound p_70014_1_) {
      ...
      p_70014_1_.setTag("Trident", this.thrownStack.write(new NBTTagCompound()));
      p_70014_1_.setBoolean("DealtDamage", this.dealtDamage);
   }
