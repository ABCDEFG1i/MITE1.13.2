   ...
   public void tick() {
      if (this.action == EntityMoveHelper.Action.MOVE_TO) {
         ...
         if (this.entity.onGround) {
            f1 = (float)(this.speed * this.entity.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue());
         } else {
            f1 = (float)(this.speed * this.entity.getAttribute(SharedMonsterAttributes.FLYING_SPEED).getAttributeValue());
         }
