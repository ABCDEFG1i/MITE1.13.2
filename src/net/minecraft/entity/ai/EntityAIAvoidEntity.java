...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase {
   private final Predicate<Entity> canBeSeenSelector = new Predicate<Entity>() {
      public boolean test(@Nullable Entity p_test_1_) {
         return p_test_1_.isEntityAlive() && EntityAIAvoidEntity.this.entity.getEntitySenses().canSee(p_test_1_) && !EntityAIAvoidEntity.this.entity.isOnSameTeam(p_test_1_);
      }
   };
   ...
   public EntityAIAvoidEntity(EntityCreature p_i46404_1_, Class<T> p_i46404_2_, float p_i46404_3_, double p_i46404_4_, double p_i46404_6_) {
      this(p_i46404_1_, p_i46404_2_, (p_200828_0_) -> {
         return true;
      }, p_i46404_3_, p_i46404_4_, p_i46404_6_, EntitySelectors.CAN_AI_TARGET);
   }
   ...
   public boolean shouldExecute() {
      List<T> list = this.entity.world.getEntitiesWithinAABB(this.classToAvoid, this.entity.getEntityBoundingBox().grow((double)this.avoidDistance, 3.0D, (double)this.avoidDistance), (p_203783_1_) -> {
