...
public class EntityAIMoveThroughVillage extends EntityAIBase {
   ...
   private VillageDoorInfo findNearestDoor(Village p_75412_1_) {
      VillageDoorInfo villagedoorinfo = null;
      int i = Integer.MAX_VALUE;

      for(VillageDoorInfo villagedoorinfo1 : p_75412_1_.getVillageDoorInfoList()) {
   ...
   private boolean doesDoorListContain(VillageDoorInfo p_75413_1_) {
      for(VillageDoorInfo villagedoorinfo : this.doorList) {
         if (p_75413_1_.getDoorBlockPos().equals(villagedoorinfo.getDoorBlockPos())) {
            return true;
         }
      }
