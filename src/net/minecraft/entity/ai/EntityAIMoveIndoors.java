...
public class EntityAIMoveIndoors extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      ...
      if ((!this.entity.world.isDaytime() || this.entity.world.isRaining() && this.entity.world.getBiome(blockpos).getPrecipitation() != Biome.RainType.RAIN) && this.entity.world.dimension.hasSkyLight()) {
