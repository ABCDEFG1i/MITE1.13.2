...
public class CloneCommand {
   ...
   public static final Predicate<BlockWorldState> IS_AIR = (p_198275_0_) -> {
   ...
   public static void register(CommandDispatcher<CommandSource> p_198265_0_) {
      p_198265_0_.register(Commands.literal("clone").requires((p_198271_0_) -> {
         ...
         return doClone(p_198276_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198276_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198276_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198276_0_, "destination"), IS_AIR, CloneCommand.Mode.NORMAL);
      }).then(Commands.literal("force").executes((p_198282_0_) -> {
         return doClone(p_198282_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198282_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198282_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198282_0_, "destination"), IS_AIR, CloneCommand.Mode.FORCE);
      })).then(Commands.literal("move").executes((p_198263_0_) -> {
         return doClone(p_198263_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198263_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198263_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198263_0_, "destination"), IS_AIR, CloneCommand.Mode.MOVE);
      })).then(Commands.literal("normal").executes((p_198266_0_) -> {
         return doClone(p_198266_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198266_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198266_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198266_0_, "destination"), IS_AIR, CloneCommand.Mode.NORMAL);
   ...
   private static int doClone(CommandSource p_198274_0_, BlockPos p_198274_1_, BlockPos p_198274_2_, BlockPos p_198274_3_, Predicate<BlockWorldState> p_198274_4_, CloneCommand.Mode p_198274_5_) throws CommandSyntaxException {
      MutableBoundingBox mutableboundingbox = new MutableBoundingBox(p_198274_1_, p_198274_2_);
      MutableBoundingBox mutableboundingbox1 = new MutableBoundingBox(p_198274_3_, p_198274_3_.add(mutableboundingbox.getLength()));
      if (!p_198274_5_.allowsOverlap() && mutableboundingbox1.intersectsWith(mutableboundingbox)) {
         ...
         if (i > 32768) {
            ...
            WorldServer worldserver = p_198274_0_.getWorld();
            if (worldserver.isAreaLoaded(mutableboundingbox) && worldserver.isAreaLoaded(mutableboundingbox1)) {
               ...
               for(int j = mutableboundingbox.minZ; j <= mutableboundingbox.maxZ; ++j) {
                  for(int k = mutableboundingbox.minY; k <= mutableboundingbox.maxY; ++k) {
                     for(int l = mutableboundingbox.minX; l <= mutableboundingbox.maxX; ++l) {
                        ...
                        if (p_198274_4_.test(blockworldstate)) {
               ...
               for(CloneCommand.BlockInfo clonecommand$blockinfo2 : list1) {
                  ...
                  if (clonecommand$blockinfo2.tag != null && tileentity3 != null) {
                     clonecommand$blockinfo2.tag.setInteger("x", clonecommand$blockinfo2.pos.getX());
                     clonecommand$blockinfo2.tag.setInteger("y", clonecommand$blockinfo2.pos.getY());
                     clonecommand$blockinfo2.tag.setInteger("z", clonecommand$blockinfo2.pos.getZ());
                     tileentity3.readFromNBT(clonecommand$blockinfo2.tag);
               ...
               if (i1 == 0) {
                  ...
                  p_198274_0_.sendFeedback(new TextComponentTranslation("commands.clone.success", i1), true);
                  return i1;
               }
            } else {
   ...
   static class BlockInfo {
      ...
      public BlockInfo(BlockPos p_i47708_1_, IBlockState p_i47708_2_, @Nullable NBTTagCompound p_i47708_3_) {
