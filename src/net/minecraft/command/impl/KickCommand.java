...
public class KickCommand {
   ...
   private static int kickPlayers(CommandSource p_198515_0_, Collection<EntityPlayerMP> p_198515_1_, ITextComponent p_198515_2_) {
      for(EntityPlayerMP entityplayermp : p_198515_1_) {
         entityplayermp.connection.disconnect(p_198515_2_);
         p_198515_0_.sendFeedback(new TextComponentTranslation("commands.kick.success", entityplayermp.getDisplayName(), p_198515_2_), true);
      }
