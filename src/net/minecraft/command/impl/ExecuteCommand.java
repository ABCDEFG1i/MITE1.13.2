...
public class ExecuteCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> p_198378_0_) {
      ...
      p_198378_0_.register(Commands.literal("execute").requires((p_198387_0_) -> {
         ...
         return p_198381_0_.getSource().withPos(p_198381_0_.getSource().getPos().func_197746_a(SwizzleArgument.getSwizzle(p_198381_0_, "axes")));
         ...
         return p_201089_0_.getSource().withWorld(p_201089_0_.getSource().getServer().func_71218_a(DimensionArgument.func_212592_a(p_201089_0_, "dimension")));
      }))));
   }
