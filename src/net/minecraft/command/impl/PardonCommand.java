...
public class PardonCommand {
   ...
   private static int unbanPlayers(CommandSource p_198548_0_, Collection<GameProfile> p_198548_1_) throws CommandSyntaxException {
      UserListBans userlistbans = p_198548_0_.getServer().getPlayerList().getBannedPlayers();
      int i = 0;
      ...
      for(GameProfile gameprofile : p_198548_1_) {
         if (userlistbans.isBanned(gameprofile)) {
            ...
            ++i;
            p_198548_0_.sendFeedback(new TextComponentTranslation("commands.pardon.success", TextComponentUtils.func_197679_a(gameprofile)), true);
         }
      }
