...
public class DataPackCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> p_198299_0_) {
      p_198299_0_.register(Commands.literal("datapack").requires((p_198301_0_) -> {
         ...
         return func_198297_a(p_198292_0_.getSource(), func_198303_a(p_198292_0_, "name", true), (p_198289_0_, p_198289_1_) -> {
         ...
         return func_198297_a(p_198307_0_.getSource(), func_198303_a(p_198307_0_, "name", true), (p_198308_1_, p_198308_2_) -> {
            p_198308_1_.add(p_198308_1_.indexOf(func_198303_a(p_198307_0_, "existing", false)) + 1, p_198308_2_);
         });
         ...
         return func_198297_a(p_198311_0_.getSource(), func_198303_a(p_198311_0_, "name", true), (p_198302_1_, p_198302_2_) -> {
            p_198302_1_.add(p_198302_1_.indexOf(func_198303_a(p_198311_0_, "existing", false)), p_198302_2_);
         });
      }))).then(Commands.literal("last").executes((p_198298_0_) -> {
         return func_198297_a(p_198298_0_.getSource(), func_198303_a(p_198298_0_, "name", true), List::add);
      })).then(Commands.literal("first").executes((p_198300_0_) -> {
         return func_198297_a(p_198300_0_.getSource(), func_198303_a(p_198300_0_, "name", true), (p_198310_0_, p_198310_1_) -> {
         ...
         return func_198312_a(p_198295_0_.getSource(), func_198303_a(p_198295_0_, "name", false));
   ...
   private static int func_198297_a(CommandSource p_198297_0_, ResourcePackInfo p_198297_1_, DataPackCommand.IHandler p_198297_2_) throws CommandSyntaxException {
      ...
      WorldInfo worldinfo = p_198297_0_.getServer().func_71218_a(DimensionType.OVERWORLD).getWorldInfo();
   ...
   private static int func_198312_a(CommandSource p_198312_0_, ResourcePackInfo p_198312_1_) {
      ResourcePackList<ResourcePackInfo> resourcepacklist = p_198312_0_.getServer().getResourcePacks();
      List<ResourcePackInfo> list = Lists.newArrayList(resourcepacklist.getPackInfos());
      list.remove(p_198312_1_);
      resourcepacklist.func_198985_a(list);
      WorldInfo worldinfo = p_198312_0_.getServer().func_71218_a(DimensionType.OVERWORLD).getWorldInfo();
      worldinfo.getEnabledDataPacks().clear();
   ...
   private static ResourcePackInfo func_198303_a(CommandContext<CommandSource> p_198303_0_, String p_198303_1_, boolean p_198303_2_) throws CommandSyntaxException {
      String s = StringArgumentType.getString(p_198303_0_, p_198303_1_);
      ResourcePackList<ResourcePackInfo> resourcepacklist = p_198303_0_.getSource().getServer().getResourcePacks();
