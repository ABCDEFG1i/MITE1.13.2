...
public class ExperienceCommand {
   ...
   private static int queryExperience(CommandSource p_198443_0_, EntityPlayerMP p_198443_1_, ExperienceCommand.Type p_198443_2_) {
      ...
      p_198443_0_.sendFeedback(new TextComponentTranslation("commands.experience.query." + p_198443_2_.name, p_198443_1_.getDisplayName(), i), false);
      return i;
   }
   ...
   private static int addExperience(CommandSource p_198448_0_, Collection<? extends EntityPlayerMP> p_198448_1_, int p_198448_2_, ExperienceCommand.Type p_198448_3_) {
      ...
      if (p_198448_1_.size() == 1) {
         p_198448_0_.sendFeedback(new TextComponentTranslation("commands.experience.add." + p_198448_3_.name + ".success.single", p_198448_2_, p_198448_1_.iterator().next().getDisplayName()), true);
      } else {
         p_198448_0_.sendFeedback(new TextComponentTranslation("commands.experience.add." + p_198448_3_.name + ".success.multiple", p_198448_2_, p_198448_1_.size()), true);
      }

      return p_198448_1_.size();
   }

   private static int setExperience(CommandSource p_198438_0_, Collection<? extends EntityPlayerMP> p_198438_1_, int p_198438_2_, ExperienceCommand.Type p_198438_3_) throws CommandSyntaxException {
      int i = 0;
      ...
      if (i == 0) {
         ...
         if (p_198438_1_.size() == 1) {
            p_198438_0_.sendFeedback(new TextComponentTranslation("commands.experience.set." + p_198438_3_.name + ".success.single", p_198438_2_, p_198438_1_.iterator().next().getDisplayName()), true);
         } else {
            p_198438_0_.sendFeedback(new TextComponentTranslation("commands.experience.set." + p_198438_3_.name + ".success.multiple", p_198438_2_, p_198438_1_.size()), true);
         }
   ...
   static enum Type {
      POINTS("points", EntityPlayer::func_195068_e, (p_198424_0_, p_198424_1_) -> {
      ...
      private Type(String p_i48027_3_, BiConsumer<EntityPlayerMP, Integer> p_i48027_4_, BiPredicate<EntityPlayerMP, Integer> p_i48027_5_, ToIntFunction<EntityPlayerMP> p_i48027_6_) {
