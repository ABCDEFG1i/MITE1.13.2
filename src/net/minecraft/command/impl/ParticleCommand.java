...
public class ParticleCommand {
   private static final SimpleCommandExceptionType FAILED_EXCEPTION = new SimpleCommandExceptionType(new TextComponentTranslation("commands.particle.failed"));
   ...
   public static void register(CommandDispatcher<CommandSource> p_198563_0_) {
      ...
      }).then(Commands.argument("viewers", EntityArgument.multiplePlayers()).executes((p_198566_0_) -> {
      ...
      }).then(Commands.argument("viewers", EntityArgument.multiplePlayers()).executes((p_198567_0_) -> {
   ...
   private static int spawnParticle(CommandSource p_198564_0_, IParticleData p_198564_1_, Vec3d p_198564_2_, Vec3d p_198564_3_, float p_198564_4_, int p_198564_5_, boolean p_198564_6_, Collection<EntityPlayerMP> p_198564_7_) throws CommandSyntaxException {
      int i = 0;

      for(EntityPlayerMP entityplayermp : p_198564_7_) {
         if (p_198564_0_.getWorld().spawnParticle(entityplayermp, p_198564_1_, p_198564_6_, p_198564_2_.x, p_198564_2_.y, p_198564_2_.z, p_198564_5_, p_198564_3_.x, p_198564_3_.y, p_198564_3_.z, (double)p_198564_4_)) {
            ++i;
         }
      }
      ...
      if (i == 0) {
         ...
         p_198564_0_.sendFeedback(new TextComponentTranslation("commands.particle.success", IRegistry.field_212632_u.func_177774_c(p_198564_1_.getType()).toString()), true);
         return i;
      }
   }
}
