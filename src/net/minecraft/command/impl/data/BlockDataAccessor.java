...
public class BlockDataAccessor implements IDataAccessor {
   ...
   public void mergeData(NBTTagCompound p_198925_1_) {
      p_198925_1_.setInteger("x", this.pos.getX());
      p_198925_1_.setInteger("y", this.pos.getY());
      p_198925_1_.setInteger("z", this.pos.getZ());
      this.tileEntity.readFromNBT(p_198925_1_);
   ...
   public NBTTagCompound getData() {
      return this.tileEntity.writeToNBT(new NBTTagCompound());
   }
