...
public class DataCommand {
   ...
   private static int dataMerge(CommandSource p_198942_0_, IDataAccessor p_198942_1_, NBTPathArgument.NBTPath p_198942_2_) throws CommandSyntaxException {
      NBTTagCompound nbttagcompound = p_198942_1_.getData();
      NBTTagCompound nbttagcompound1 = nbttagcompound.copy();
      p_198942_2_.func_197140_b(nbttagcompound);
      if (nbttagcompound1.equals(nbttagcompound)) {
         throw MERGE_FAILED_EXCEPTION.create();
      } else {
         p_198942_1_.mergeData(nbttagcompound);
   ...
   private static int dataGet(CommandSource p_201228_0_, IDataAccessor p_201228_1_, NBTPathArgument.NBTPath p_201228_2_) throws CommandSyntaxException {
      ...
      if (inbtbase instanceof NBTPrimitive) {
         ...
         i = ((NBTTagCompound)inbtbase).getSize();
      } else {
