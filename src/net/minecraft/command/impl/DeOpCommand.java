...
public class DeOpCommand {
   private static final SimpleCommandExceptionType FAILED_EXCEPTION = new SimpleCommandExceptionType(new TextComponentTranslation("commands.deop.failed"));
   ...
   private static int deopPlayers(CommandSource p_198322_0_, Collection<GameProfile> p_198322_1_) throws CommandSyntaxException {
      ...
      for(GameProfile gameprofile : p_198322_1_) {
         if (playerlist.canSendCommands(gameprofile)) {
            ...
            ++i;
            p_198322_0_.sendFeedback(new TextComponentTranslation("commands.deop.success", p_198322_1_.iterator().next().getName()), true);
         }
      }
