...
public class GiveCommand {
   ...
   private static int giveItem(CommandSource p_198497_0_, ItemInput p_198497_1_, Collection<EntityPlayerMP> p_198497_2_, int p_198497_3_) throws CommandSyntaxException {
      for(EntityPlayerMP entityplayermp : p_198497_2_) {
         int i = p_198497_3_;
      ...
      if (p_198497_2_.size() == 1) {
         p_198497_0_.sendFeedback(new TextComponentTranslation("commands.give.success.single", p_198497_3_, p_198497_1_.createStack(p_198497_3_, false).getTextComponent(), p_198497_2_.iterator().next().getDisplayName()), true);
      } else {
         p_198497_0_.sendFeedback(new TextComponentTranslation("commands.give.success.single", p_198497_3_, p_198497_1_.createStack(p_198497_3_, false).getTextComponent(), p_198497_2_.size()), true);
      }
