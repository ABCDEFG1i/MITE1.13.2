...
public class Commands {
   ...
   public int handleCommand(CommandSource p_197059_1_, String p_197059_2_) {
      ...
      p_197059_1_.getServer().profiler.startSection(p_197059_2_);

      try {
         try {
            int lvt_4_3_ = this.dispatcher.execute(stringreader, p_197059_1_);
            return lvt_4_3_;
         } catch (CommandException commandexception) {
            p_197059_1_.sendErrorMessage(commandexception.func_197003_a());
            byte b1 = 0;
            return b1;
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
               ...
               ITextComponent itextcomponent1 = (new TextComponentString("")).applyTextStyle(TextFormatting.GRAY).applyTextStyle((p_211705_1_) -> {
                  p_211705_1_.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, p_197059_2_));
               });
               if (k > 10) {
   ...
   public void sendCommandListPacket(EntityPlayerMP p_197051_1_) {
      ...
      this.func_197052_a(this.dispatcher.getRoot(), rootcommandnode, p_197051_1_.getCommandSource(), map);
