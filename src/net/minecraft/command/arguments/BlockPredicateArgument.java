...
public class BlockPredicateArgument implements ArgumentType<BlockPredicateArgument.IResult> {
   ...
   public BlockPredicateArgument.IResult parse(StringReader p_parse_1_) throws CommandSyntaxException {
      ...
      if (blockstateparser.func_197249_b() != null) {
         BlockPredicateArgument.BlockPredicate blockpredicateargument$blockpredicate = new BlockPredicateArgument.BlockPredicate(blockstateparser.func_197249_b(), blockstateparser.func_197254_a().keySet(), blockstateparser.func_197241_c());
         return (p_199823_1_) -> {
         ...
         return (p_199822_2_) -> {
            ...
            if (tag == null) {
               ...
               return new BlockPredicateArgument.TagPredicate(tag, blockstateparser.func_200139_j(), blockstateparser.func_197241_c());
            }
         };
      }
   }

   public static Predicate<BlockWorldState> getBlockPredicate(CommandContext<CommandSource> p_199825_0_, String p_199825_1_) throws CommandSyntaxException {
      return p_199825_0_.getArgument(p_199825_1_, BlockPredicateArgument.IResult.class).create(p_199825_0_.getSource().getServer().getNetworkTagManager());
   }
      ...
      public boolean test(BlockWorldState p_test_1_) {
         ...
         if (iblockstate.getBlock() != this.field_199817_a.getBlock()) {
            ...
            if (this.field_199819_c == null) {
               ...
               return tileentity != null && NBTUtil.areNBTEquals(this.field_199819_c, tileentity.writeToNBT(new NBTTagCompound()), true);
            }
         }
      }
   }
      ...
      public boolean test(BlockWorldState p_test_1_) {
         ...
         if (!iblockstate.isIn(this.field_199820_a)) {
            ...
            if (this.field_199821_b == null) {
               ...
               TileEntity tileentity = p_test_1_.getTileEntity();
               return tileentity != null && NBTUtil.areNBTEquals(this.field_199821_b, tileentity.writeToNBT(new NBTTagCompound()), true);
            }
         }
      }
   }
