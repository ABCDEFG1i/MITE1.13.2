...
public class FloatSerializer implements IArgumentSerializer<FloatArgumentType> {
   ...
   public FloatArgumentType read(PacketBuffer p_197071_1_) {
      ...
      float f = BrigadierSerializers.hasMin(b0) ? p_197071_1_.readFloat() : -Float.MAX_VALUE;
      float f1 = BrigadierSerializers.hasMax(b0) ? p_197071_1_.readFloat() : Float.MAX_VALUE;
      return FloatArgumentType.floatArg(f, f1);
   }

   public void func_212244_a(FloatArgumentType p_212244_1_, JsonObject p_212244_2_) {
