...
public class IntSerializer implements IArgumentSerializer<IntegerArgumentType> {
   ...
   public IntegerArgumentType read(PacketBuffer p_197071_1_) {
      ...
      int i = BrigadierSerializers.hasMin(b0) ? p_197071_1_.readInt() : Integer.MIN_VALUE;
      int j = BrigadierSerializers.hasMax(b0) ? p_197071_1_.readInt() : Integer.MAX_VALUE;
      return IntegerArgumentType.integer(i, j);
   }

   public void func_212244_a(IntegerArgumentType p_212244_1_, JsonObject p_212244_2_) {
