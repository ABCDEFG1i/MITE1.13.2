...
public class MessageArgument implements ArgumentType<MessageArgument.Message> {
   ...
   public static ITextComponent getMessage(CommandContext<CommandSource> p_197124_0_, String p_197124_1_) throws CommandSyntaxException {
      return p_197124_0_.getArgument(p_197124_1_, MessageArgument.Message.class).func_201312_a(p_197124_0_.getSource(), p_197124_0_.getSource().hasPermissionLevel(2));
   }
   ...
   public static class Part {
      ...
      public ITextComponent func_197116_a(CommandSource p_197116_1_) throws CommandSyntaxException {
         return EntitySelector.func_197350_a(this.field_197121_c.select(p_197116_1_));
      }
   }
}
