...
public class EntitySelector {
   ...
   public List<? extends Entity> select(CommandSource p_197341_1_) throws CommandSyntaxException {
      ...
      if (!this.includeNonPlayers) {
         ...
         EntityPlayerMP entityplayermp = p_197341_1_.getServer().getPlayerList().getPlayerByUsername(this.username);
         return (List<? extends Entity>)(entityplayermp == null ? Collections.emptyList() : Lists.newArrayList(entityplayermp));
      } else if (this.uuid != null) {
         for(WorldServer worldserver1 : p_197341_1_.getServer().func_212370_w()) {
         ...
         Vec3d vec3d = this.positionGetter.apply(p_197341_1_.getPos());
         ...
         if (this.self) {
            ...
            if (this.func_197353_d()) {
               this.getEntities(list, p_197341_1_.getWorld(), vec3d, predicate);
            } else {
               for(WorldServer worldserver : p_197341_1_.getServer().func_212370_w()) {
   ...
   public EntityPlayerMP selectOnePlayer(CommandSource p_197347_1_) throws CommandSyntaxException {
      this.checkPermission(p_197347_1_);
      List<EntityPlayerMP> list = this.selectPlayers(p_197347_1_);
      if (list.size() != 1) {
   ...
   private Predicate<Entity> updateFilter(Vec3d p_197349_1_) {
      ...
      if (this.aabb != null) {
         ...
         predicate = predicate.and((p_197344_1_) -> {
            return axisalignedbb.intersects(p_197344_1_.getEntityBoundingBox());
         });
      }
   ...
   public static ITextComponent func_197350_a(List<? extends Entity> p_197350_0_) {
