   ...
   public boolean test(BlockWorldState p_test_1_) {
      ...
      if (iblockstate.getBlock() != this.blockState.getBlock()) {
         ...
         if (this.tileNBT == null) {
            ...
            return tileentity != null && NBTUtil.areNBTEquals(this.tileNBT, tileentity.writeToNBT(new NBTTagCompound()), true);
         }
      }
   }

   public boolean func_197230_a(WorldServer p_197230_1_, BlockPos p_197230_2_, int p_197230_3_) {
      if (!p_197230_1_.setBlockState(p_197230_2_, this.blockState, p_197230_3_)) {
         ...
         if (this.tileNBT != null) {
            ...
            if (tileentity != null) {
               ...
               nbttagcompound.setInteger("x", p_197230_2_.getX());
               nbttagcompound.setInteger("y", p_197230_2_.getY());
               nbttagcompound.setInteger("z", p_197230_2_.getZ());
