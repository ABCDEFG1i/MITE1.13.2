...
public class PotionArgument implements ArgumentType<Potion> {
   ...
   public static Potion getMobEffect(CommandContext<CommandSource> p_197125_0_, String p_197125_1_) throws CommandSyntaxException {
      return p_197125_0_.getArgument(p_197125_1_, Potion.class);
   }
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> p_listSuggestions_1_, SuggestionsBuilder p_listSuggestions_2_) {
      return ISuggestionProvider.suggestIterable(IRegistry.field_212631_t.func_148742_b(), p_listSuggestions_2_);
   }
