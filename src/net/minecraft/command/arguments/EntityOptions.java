   ...
   public static void registerOptions() {
      if (REGISTRY.isEmpty()) {
         register("name", (p_197440_0_) -> {
            ...
            return !p_202016_0_.func_201984_u();
         ...
         register("distance", (p_197439_0_) -> {
            ...
            MinMaxBounds.FloatBound minmaxbounds$floatbound = MinMaxBounds.FloatBound.func_211357_a(p_197439_0_.getReader());
            if ((minmaxbounds$floatbound.func_196973_a() == null || !(minmaxbounds$floatbound.func_196973_a() < 0.0F)) && (minmaxbounds$floatbound.func_196977_b() == null || !(minmaxbounds$floatbound.func_196977_b() < 0.0F))) {
         ...
         register("level", (p_197438_0_) -> {
            ...
            MinMaxBounds.IntBound minmaxbounds$intbound = MinMaxBounds.IntBound.func_211342_a(p_197438_0_.getReader());
            if ((minmaxbounds$intbound.func_196973_a() == null || minmaxbounds$intbound.func_196973_a() >= 0) && (minmaxbounds$intbound.func_196977_b() == null || minmaxbounds$intbound.func_196977_b() >= 0)) {
         ...
         register("limit", (p_197456_0_) -> {
            ...
            if (j < 1) {
               ...
               p_197456_0_.func_201979_e(true);
            }
         }, (p_202035_0_) -> {
            return !p_202035_0_.func_197381_m() && !p_202035_0_.func_201967_w();
         ...
         register("sort", (p_197455_0_) -> {
            ...
            p_197455_0_.func_201986_f(true);
         }, (p_202043_0_) -> {
            return !p_202043_0_.func_197381_m() && !p_202043_0_.func_201976_x();
         ...
         register("gamemode", (p_197452_0_) -> {
            p_197452_0_.setSuggestionHandler((p_202018_1_, p_202018_2_) -> {
               ...
               boolean flag1 = !p_197452_0_.func_201961_z();
               boolean flag2 = true;
               if (!s1.isEmpty()) {
                  if (s1.charAt(0) == '!') {
                     flag1 = false;
            ...
            boolean flag = p_197452_0_.func_197378_e();
            if (p_197452_0_.func_201961_z() && !flag) {
               ...
               if (gametype == GameType.NOT_SET) {
                  ...
                  if (flag) {
                     p_197452_0_.func_201973_h(true);
                  } else {
                     p_197452_0_.func_201988_g(true);
                  }

               }
            }
         }, (p_202048_0_) -> {
            return !p_202048_0_.func_201987_y();
         }, new TextComponentTranslation("argument.entity.options.gamemode.description"));
         register("team", (p_197449_0_) -> {
            boolean flag = p_197449_0_.func_197378_e();
            ...
            if (flag) {
               p_197449_0_.func_201958_j(true);
            } else {
               p_197449_0_.func_201975_i(true);
            }

         }, (p_202038_0_) -> {
            return !p_202038_0_.func_201960_A();
         ...
         register("type", (p_197447_0_) -> {
            p_197447_0_.setSuggestionHandler((p_202052_1_, p_202052_2_) -> {
               ISuggestionProvider.suggestIterable(IRegistry.field_212629_r.func_148742_b(), p_202052_1_, String.valueOf('!'));
               if (!p_197447_0_.func_201985_F()) {
                  ISuggestionProvider.suggestIterable(IRegistry.field_212629_r.func_148742_b(), p_202052_1_);
               }

               return p_202052_1_.buildFuture();
            });
            int i = p_197447_0_.getReader().getCursor();
            boolean flag = p_197447_0_.func_197378_e();
            if (p_197447_0_.func_201985_F() && !flag) {
               ...
               if (entitytype == null) {
                  ...
                  if (flag) {
                     p_197447_0_.func_201982_C();
                  } else {
                     p_197447_0_.func_201964_a(entitytype.getEntityClass());
                  }

               }
            }
         }, (p_202047_0_) -> {
            return !p_202047_0_.func_201963_E();
         }, new TextComponentTranslation("argument.entity.options.type.description"));
         register("tag", (p_197448_0_) -> {
            boolean flag = p_197448_0_.func_197378_e();
         ...
         register("nbt", (p_197450_0_) -> {
            boolean flag = p_197450_0_.func_197378_e();
            NBTTagCompound nbttagcompound = (new JsonToNBT(p_197450_0_.getReader())).readStruct();
            p_197450_0_.addFilter((p_197443_2_) -> {
               NBTTagCompound nbttagcompound1 = p_197443_2_.writeToNBT(new NBTTagCompound());
         ...
         register("scores", (p_197457_0_) -> {
            ...
            while(stringreader.canRead() && stringreader.peek() != '}') {
               ...
               stringreader.expect('=');
               stringreader.skipWhitespace();
               MinMaxBounds.IntBound minmaxbounds$intbound = MinMaxBounds.IntBound.func_211342_a(stringreader);
            ...
            p_197457_0_.func_201970_k(true);
         }, (p_202033_0_) -> {
            return !p_202033_0_.func_201995_G();
         ...
         register("advancements", (p_197453_0_) -> {
            ...
            p_197453_0_.func_201992_l(true);
         }, (p_202032_0_) -> {
            return !p_202032_0_.func_201966_H();
         }, new TextComponentTranslation("argument.entity.options.advancements.description"));
      }
   }

   public static EntityOptions.Filter func_202017_a(EntitySelectorParser p_202017_0_, String p_202017_1_, int p_202017_2_) throws CommandSyntaxException {
