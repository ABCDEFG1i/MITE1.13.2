...
public class ScoreObjective {
   ...
   public ScoreObjective(Scoreboard p_i49788_1_, String p_i49788_2_, ScoreCriteria p_i49788_3_, ITextComponent p_i49788_4_, ScoreCriteria.RenderType p_i49788_5_) {
      ...
      this.field_199867_e = p_i49788_5_;
   }
   ...
   public ITextComponent func_197890_e() {
      return TextComponentUtils.wrapInSquareBrackets(this.displayName.func_212638_h().applyTextStyle((p_211544_1_) -> {
         p_211544_1_.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(this.getName())));
      }));
   }

   public void func_199864_a(ITextComponent p_199864_1_) {
      this.displayName = p_199864_1_;
      this.scoreboard.func_199869_b(this);
   }
   ...
   public void func_199866_a(ScoreCriteria.RenderType p_199866_1_) {
      this.field_199867_e = p_199866_1_;
      this.scoreboard.func_199869_b(this);
   }
}
